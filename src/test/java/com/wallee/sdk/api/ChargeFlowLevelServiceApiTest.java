...
/**
 * API tests for ChargeFlowLevelServiceApi
 */
public class ChargeFlowLevelServiceApiTest {

    private final ChargeFlowLevelServiceApi api = new ChargeFlowLevelServiceApi();
    ...
    public void readTest() throws ApiException {
        Long spaceId = null;
        Long id = null;
        // ChargeFlowLevel response = api.read(spaceId, id);
    ...
    public void searchTest() throws ApiException {
        ...
        // List<ChargeFlowLevel> response = api.search(spaceId, query);
    ...
    public void sendMessageTest() throws ApiException {
        Long spaceId = null;
        Long id = null;
        // ChargeFlowLevel response = api.sendMessage(spaceId, id);
