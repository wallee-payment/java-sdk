...
public class ApiClient {
    ...
    public ApiClient(long userId, String applicationKey) {
        ...
        setUserAgent("com.wallee.wallee-java-sdk-1.1.1");
    ...
    public Call buildCall(String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, Object> formParams, String[] authNames, ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        appendAuthenticationHeaders(url, method, reqBuilder);
	...
	private void appendAuthenticationHeaders(String url, String method, Request.Builder reqBuilder) {
    	...
    	reqBuilder.addHeader("x-mac-version", version);
    	reqBuilder.addHeader("x-mac-userid", Long.toString(this.userId));
