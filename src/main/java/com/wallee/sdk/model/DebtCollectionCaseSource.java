 ...
 */
@JsonPropertyOrder({
  DebtCollectionCaseSource.JSON_PROPERTY_FORCED_PREPARING_STATE,
  DebtCollectionCaseSource.JSON_PROPERTY_NAME,
  DebtCollectionCaseSource.JSON_PROPERTY_DESCRIPTION,
  DebtCollectionCaseSource.JSON_PROPERTY_ID
})
...
public class DebtCollectionCaseSource {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.forcedPreparingState, debtCollectionCaseSource.forcedPreparingState) &&
        Objects.equals(this.name, debtCollectionCaseSource.name) &&
        Objects.equals(this.description, debtCollectionCaseSource.description) &&
        Objects.equals(this.id, debtCollectionCaseSource.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(forcedPreparingState, name, description, id);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `forcedPreparingState` to the URL query string
    if (getForcedPreparingState() != null) {
      try {
        joiner.add(String.format("%sforcedPreparingState%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getForcedPreparingState()), "UTF-8").replaceAll("\\+", "%20")));
