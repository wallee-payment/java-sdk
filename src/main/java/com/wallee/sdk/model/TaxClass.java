 ...
 */
@JsonPropertyOrder({
  TaxClass.JSON_PROPERTY_LINKED_SPACE_ID,
  TaxClass.JSON_PROPERTY_NAME,
  TaxClass.JSON_PROPERTY_PLANNED_PURGE_DATE,
  TaxClass.JSON_PROPERTY_ID,
  TaxClass.JSON_PROPERTY_STATE,
  TaxClass.JSON_PROPERTY_VERSION
})
...
public class TaxClass {
  ...
  public TaxClass state(@javax.annotation.Nullable CreationEntityState state) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.linkedSpaceId, taxClass.linkedSpaceId) &&
