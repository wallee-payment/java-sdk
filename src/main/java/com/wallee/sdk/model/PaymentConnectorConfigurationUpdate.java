...
import com.wallee.sdk.model.Condition;
import com.wallee.sdk.model.SalesChannel;
 ...
 */
@JsonPropertyOrder({
  PaymentConnectorConfigurationUpdate.JSON_PROPERTY_NAME,
  PaymentConnectorConfigurationUpdate.JSON_PROPERTY_ENABLED_SPACE_VIEWS,
  PaymentConnectorConfigurationUpdate.JSON_PROPERTY_CONDITIONS,
  PaymentConnectorConfigurationUpdate.JSON_PROPERTY_PRIORITY,
  PaymentConnectorConfigurationUpdate.JSON_PROPERTY_ENABLED_SALES_CHANNELS,
  PaymentConnectorConfigurationUpdate.JSON_PROPERTY_VERSION
})
@JsonTypeName("PaymentConnectorConfiguration.Update")
...
public class PaymentConnectorConfigurationUpdate {
  ...
  public PaymentConnectorConfigurationUpdate addEnabledSpaceViewsItem(Long enabledSpaceViewsItem) {
  ...
  public PaymentConnectorConfigurationUpdate addConditionsItem(Condition conditionsItem) {
  ...
  public PaymentConnectorConfigurationUpdate addEnabledSalesChannelsItem(SalesChannel enabledSalesChannelsItem) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentConnectorConfigurationUpdate paymentConnectorConfigurationUpdate = (PaymentConnectorConfigurationUpdate) o;
    return Objects.equals(this.name, paymentConnectorConfigurationUpdate.name) &&
        Objects.equals(this.enabledSpaceViews, paymentConnectorConfigurationUpdate.enabledSpaceViews) &&
        Objects.equals(this.conditions, paymentConnectorConfigurationUpdate.conditions) &&
        Objects.equals(this.priority, paymentConnectorConfigurationUpdate.priority) &&
        Objects.equals(this.enabledSalesChannels, paymentConnectorConfigurationUpdate.enabledSalesChannels) &&
        Objects.equals(this.version, paymentConnectorConfigurationUpdate.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, enabledSpaceViews, conditions, priority, enabledSalesChannels, version);
  }
