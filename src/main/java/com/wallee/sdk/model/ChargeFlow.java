 ...
 */
@JsonPropertyOrder({
  ChargeFlow.JSON_PROPERTY_LINKED_SPACE_ID,
  ChargeFlow.JSON_PROPERTY_NAME,
  ChargeFlow.JSON_PROPERTY_PLANNED_PURGE_DATE,
  ChargeFlow.JSON_PROPERTY_ID,
  ChargeFlow.JSON_PROPERTY_STATE,
  ChargeFlow.JSON_PROPERTY_CONDITIONS,
  ChargeFlow.JSON_PROPERTY_PRIORITY,
  ChargeFlow.JSON_PROPERTY_VERSION
})
...
public class ChargeFlow {
  ...
  public ChargeFlow state(@javax.annotation.Nullable CreationEntityState state) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.linkedSpaceId, chargeFlow.linkedSpaceId) &&
        ...
        Objects.equals(this.conditions, chargeFlow.conditions) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(linkedSpaceId, name, plannedPurgeDate, id, state, conditions, priority, version);
  }
