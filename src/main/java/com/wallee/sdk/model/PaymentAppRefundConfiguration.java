 ...
 */
@JsonPropertyOrder({
  PaymentAppRefundConfiguration.JSON_PROPERTY_REFUND_TIMEOUT_IN_MINUTES,
  PaymentAppRefundConfiguration.JSON_PROPERTY_MULTIPLE_REFUNDS_SUPPORTED,
  PaymentAppRefundConfiguration.JSON_PROPERTY_REFUND_ENDPOINT
})
...
public class PaymentAppRefundConfiguration {
  ...
  @JsonCreator
  public PaymentAppRefundConfiguration(
    @JsonProperty(JSON_PROPERTY_REFUND_TIMEOUT_IN_MINUTES) Integer refundTimeoutInMinutes, 
    @JsonProperty(JSON_PROPERTY_MULTIPLE_REFUNDS_SUPPORTED) Boolean multipleRefundsSupported, 
    @JsonProperty(JSON_PROPERTY_REFUND_ENDPOINT) String refundEndpoint
  ) {
    this();
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.refundTimeoutInMinutes, paymentAppRefundConfiguration.refundTimeoutInMinutes) &&
        Objects.equals(this.multipleRefundsSupported, paymentAppRefundConfiguration.multipleRefundsSupported) &&
