 ...
 */
@JsonPropertyOrder({
  RefundCommentActive.JSON_PROPERTY_CONTENT,
  RefundCommentActive.JSON_PROPERTY_VERSION
})
@JsonTypeName("RefundComment.Active")

public class RefundCommentActive {
  ...
  public RefundCommentActive() {
  }

  public RefundCommentActive content(@javax.annotation.Nullable String content) {
  ...
  public RefundCommentActive version(@javax.annotation.Nonnull Integer version) {
