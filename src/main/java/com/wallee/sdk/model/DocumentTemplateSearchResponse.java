 ...
 */
@JsonPropertyOrder({
  DocumentTemplateSearchResponse.JSON_PROPERTY_DATA,
  DocumentTemplateSearchResponse.JSON_PROPERTY_OFFSET,
  DocumentTemplateSearchResponse.JSON_PROPERTY_HAS_MORE,
  DocumentTemplateSearchResponse.JSON_PROPERTY_LIMIT
})
@JsonTypeName("Document_Template_Search_Response")

public class DocumentTemplateSearchResponse {
  public static final String JSON_PROPERTY_DATA = "data";
  private List<DocumentTemplate> data = new ArrayList<>();
  ...
  */
  @JsonCreator
  public DocumentTemplateSearchResponse(
    @JsonProperty(JSON_PROPERTY_DATA) List<DocumentTemplate> data, 
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DocumentTemplateSearchResponse documentTemplateSearchResponse = (DocumentTemplateSearchResponse) o;
    return Objects.equals(this.data, documentTemplateSearchResponse.data) &&
        Objects.equals(this.offset, documentTemplateSearchResponse.offset) &&
        Objects.equals(this.hasMore, documentTemplateSearchResponse.hasMore) &&
        Objects.equals(this.limit, documentTemplateSearchResponse.limit);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentTemplateSearchResponse {\n");
