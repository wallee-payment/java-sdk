 ...
 */
@JsonPropertyOrder({
  User.JSON_PROPERTY_SCOPE,
  User.JSON_PROPERTY_PLANNED_PURGE_DATE,
...
public class User {
  ...
  public User state(@javax.annotation.Nullable CreationEntityState state) {
  ...
  public User userType(@javax.annotation.Nullable UserType userType) {
  ...
  public boolean equals(Object o) {
    ...
    User user = (User) o;
    return Objects.equals(this.scope, user.scope) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(scope, plannedPurgeDate, id, state, userType, version);
  }
