 ...
 */
@JsonPropertyOrder({
  SubscriptionMetric.JSON_PROPERTY_LINKED_SPACE_ID,
  SubscriptionMetric.JSON_PROPERTY_NAME,
  SubscriptionMetric.JSON_PROPERTY_PLANNED_PURGE_DATE,
  SubscriptionMetric.JSON_PROPERTY_DESCRIPTION,
  SubscriptionMetric.JSON_PROPERTY_ID,
  SubscriptionMetric.JSON_PROPERTY_STATE,
  SubscriptionMetric.JSON_PROPERTY_TYPE,
  SubscriptionMetric.JSON_PROPERTY_VERSION
})
...
public class SubscriptionMetric {
  ...
  @javax.annotation.Nullable
  private SubscriptionMetricType type;
  ...
  public SubscriptionMetric state(@javax.annotation.Nullable CreationEntityState state) {
  ...
  public SubscriptionMetric type(@javax.annotation.Nullable SubscriptionMetricType type) {
  ...
  @JsonProperty(JSON_PROPERTY_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setType(@javax.annotation.Nullable SubscriptionMetricType type) {
    this.type = type;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.linkedSpaceId, subscriptionMetric.linkedSpaceId) &&
        Objects.equals(this.name, subscriptionMetric.name) &&
        Objects.equals(this.plannedPurgeDate, subscriptionMetric.plannedPurgeDate) &&
        Objects.equals(this.description, subscriptionMetric.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(linkedSpaceId, name, plannedPurgeDate, description, id, state, type, version);
  }
