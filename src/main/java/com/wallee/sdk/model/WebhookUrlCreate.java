 ...
 */
@JsonPropertyOrder({
  WebhookUrlCreate.JSON_PROPERTY_NAME,
  WebhookUrlCreate.JSON_PROPERTY_STATE,
  WebhookUrlCreate.JSON_PROPERTY_URL
})
@JsonTypeName("WebhookUrl.Create")

public class WebhookUrlCreate {
  ...
  public WebhookUrlCreate() {
  }

  public WebhookUrlCreate name(@javax.annotation.Nullable String name) {
  ...
  public WebhookUrlCreate state(@javax.annotation.Nullable CreationEntityState state) {
  ...
  public WebhookUrlCreate url(@javax.annotation.Nullable String url) {
