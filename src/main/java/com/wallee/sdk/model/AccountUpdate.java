 ...
 */
@JsonPropertyOrder({
  AccountUpdate.JSON_PROPERTY_NAME,
  AccountUpdate.JSON_PROPERTY_SUBACCOUNT_LIMIT,
  AccountUpdate.JSON_PROPERTY_VERSION
})
@JsonTypeName("Account.Update")
...
public class AccountUpdate {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, subaccountLimit, version);
  }
