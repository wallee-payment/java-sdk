 ...
 */
@JsonPropertyOrder({
  DeliveryIndicationDecisionReason.JSON_PROPERTY_NAME,
  DeliveryIndicationDecisionReason.JSON_PROPERTY_DESCRIPTION,
  DeliveryIndicationDecisionReason.JSON_PROPERTY_ID
})

public class DeliveryIndicationDecisionReason {
  ...
  public DeliveryIndicationDecisionReason() {
  }
  /**
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, deliveryIndicationDecisionReason.name) &&
        Objects.equals(this.description, deliveryIndicationDecisionReason.description) &&
