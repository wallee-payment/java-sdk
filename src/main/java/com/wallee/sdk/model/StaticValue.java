 ...
 */
@JsonPropertyOrder({
  StaticValue.JSON_PROPERTY_FEATURES,
  StaticValue.JSON_PROPERTY_NAME,
  StaticValue.JSON_PROPERTY_DESCRIPTION,
  StaticValue.JSON_PROPERTY_ID
})
...
public class StaticValue {
  ...
  */
  @JsonCreator
  public StaticValue(
    @JsonProperty(JSON_PROPERTY_FEATURES) List<Long> features, 
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.features, staticValue.features) &&
        Objects.equals(this.name, staticValue.name) &&
        Objects.equals(this.description, staticValue.description) &&
        Objects.equals(this.id, staticValue.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(features, name, description, id);
  }
