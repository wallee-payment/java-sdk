 ...
 */
@JsonPropertyOrder({
  CustomerCommentCreate.JSON_PROPERTY_CONTENT,
  CustomerCommentCreate.JSON_PROPERTY_CUSTOMER
})
@JsonTypeName("CustomerComment.Create")
...
public class CustomerCommentCreate {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(content, customer);
  }
