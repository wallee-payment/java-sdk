 ...
 */
@JsonPropertyOrder({
  TerminalSearchResponse.JSON_PROPERTY_DATA,
  TerminalSearchResponse.JSON_PROPERTY_OFFSET,
  TerminalSearchResponse.JSON_PROPERTY_HAS_MORE,
  TerminalSearchResponse.JSON_PROPERTY_LIMIT
})
@JsonTypeName("Terminal_Search_Response")

public class TerminalSearchResponse {
  public static final String JSON_PROPERTY_DATA = "data";
  private List<PaymentTerminal> data = new ArrayList<>();
  ...
  */
  @JsonCreator
  public TerminalSearchResponse(
    @JsonProperty(JSON_PROPERTY_DATA) List<PaymentTerminal> data, 
  ...
  **/
  ...
  public List<PaymentTerminal> getData() {
    return data;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TerminalSearchResponse terminalSearchResponse = (TerminalSearchResponse) o;
    return Objects.equals(this.data, terminalSearchResponse.data) &&
        Objects.equals(this.offset, terminalSearchResponse.offset) &&
        Objects.equals(this.hasMore, terminalSearchResponse.hasMore) &&
        Objects.equals(this.limit, terminalSearchResponse.limit);
  }
  ...
  public String toString() {
    ...
    sb.append("class TerminalSearchResponse {\n");
