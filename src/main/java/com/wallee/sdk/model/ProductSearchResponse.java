 ...
 */
@JsonPropertyOrder({
  ProductSearchResponse.JSON_PROPERTY_DATA,
  ProductSearchResponse.JSON_PROPERTY_OFFSET,
  ProductSearchResponse.JSON_PROPERTY_HAS_MORE,
  ProductSearchResponse.JSON_PROPERTY_LIMIT
})
@JsonTypeName("Product_Search_Response")

public class ProductSearchResponse {
  public static final String JSON_PROPERTY_DATA = "data";
  private List<SubscriptionProduct> data = new ArrayList<>();
  ...
  */
  @JsonCreator
  public ProductSearchResponse(
    @JsonProperty(JSON_PROPERTY_DATA) List<SubscriptionProduct> data, 
  ...
  **/
  ...
  public List<SubscriptionProduct> getData() {
    return data;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, productSearchResponse.data) &&
        Objects.equals(this.offset, productSearchResponse.offset) &&
        Objects.equals(this.hasMore, productSearchResponse.hasMore) &&
