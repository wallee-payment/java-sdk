...
public class EntityExportRequest {
	 ...
	 *
	 * @return The properties is a list of property paths which should be exported.
	 */
	 ...
	 *
	 * @return The query limits the returned entries. The query allows to restrict the entries to return and it allows to control the order of them.
	 */
