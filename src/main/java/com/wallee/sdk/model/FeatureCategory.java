 ...
 */
@JsonPropertyOrder({
  FeatureCategory.JSON_PROPERTY_NAME,
  FeatureCategory.JSON_PROPERTY_DESCRIPTION,
  FeatureCategory.JSON_PROPERTY_ORDER_WEIGHT,
  FeatureCategory.JSON_PROPERTY_ID
})
...
public class FeatureCategory {
  ...
  public static final String JSON_PROPERTY_ORDER_WEIGHT = "orderWeight";
  ...
  */
  ...
  public FeatureCategory(
    ...
    @JsonProperty(JSON_PROPERTY_ORDER_WEIGHT) Integer orderWeight, 
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ORDER_WEIGHT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, featureCategory.name) &&
        Objects.equals(this.description, featureCategory.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, orderWeight, id);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `orderWeight` to the URL query string
    if (getOrderWeight() != null) {
      try {
        joiner.add(String.format("%sorderWeight%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getOrderWeight()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
