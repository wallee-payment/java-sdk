 ...
 */
@JsonPropertyOrder({
  BankAccountSearchResponse.JSON_PROPERTY_DATA,
  BankAccountSearchResponse.JSON_PROPERTY_OFFSET,
  BankAccountSearchResponse.JSON_PROPERTY_HAS_MORE,
  BankAccountSearchResponse.JSON_PROPERTY_LIMIT
})
@JsonTypeName("Bank_Account_Search_Response")

public class BankAccountSearchResponse {
  public static final String JSON_PROPERTY_DATA = "data";
  private List<BankAccount> data = new ArrayList<>();
  ...
  public BankAccountSearchResponse() {
  }
  /**
  ...
  */
  @JsonCreator
  public BankAccountSearchResponse(
    @JsonProperty(JSON_PROPERTY_DATA) List<BankAccount> data, 
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BankAccountSearchResponse bankAccountSearchResponse = (BankAccountSearchResponse) o;
    return Objects.equals(this.data, bankAccountSearchResponse.data) &&
        Objects.equals(this.offset, bankAccountSearchResponse.offset) &&
        Objects.equals(this.hasMore, bankAccountSearchResponse.hasMore) &&
        Objects.equals(this.limit, bankAccountSearchResponse.limit);
  }
  ...
  public String toString() {
    ...
    sb.append("class BankAccountSearchResponse {\n");
