...
public class TransactionCommentActive extends AbstractTransactionCommentActive implements UpsertableEntity {
    ...
    public TransactionCommentActive id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public TransactionCommentActive version(Long version) {
    ...
    public String toString() {
        return "class TransactionCommentActive { \n" +
