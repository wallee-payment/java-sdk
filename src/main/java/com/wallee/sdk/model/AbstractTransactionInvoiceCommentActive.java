 ...
 */
@JsonPropertyOrder({
  AbstractTransactionInvoiceCommentActive.JSON_PROPERTY_CONTENT
})
@JsonTypeName("Abstract.TransactionInvoiceComment.Active")

public class AbstractTransactionInvoiceCommentActive {
  public static final String JSON_PROPERTY_CONTENT = "content";
  @javax.annotation.Nullable
  private String content;

  public AbstractTransactionInvoiceCommentActive() {
  }

  public AbstractTransactionInvoiceCommentActive content(@javax.annotation.Nullable String content) {
  ...
  public String toString() {
    ...
    sb.append("class AbstractTransactionInvoiceCommentActive {\n");
