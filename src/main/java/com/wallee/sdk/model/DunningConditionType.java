 ...
 */
@JsonPropertyOrder({
  DunningConditionType.JSON_PROPERTY_NAME,
  DunningConditionType.JSON_PROPERTY_DESCRIPTION,
  DunningConditionType.JSON_PROPERTY_ID
})

public class DunningConditionType {
  ...
  public boolean equals(Object o) {
    ...
    DunningConditionType dunningConditionType = (DunningConditionType) o;
    return Objects.equals(this.name, dunningConditionType.name) &&
        Objects.equals(this.description, dunningConditionType.description) &&
        Objects.equals(this.id, dunningConditionType.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class DunningConditionType {\n");
