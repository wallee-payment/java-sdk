 ...
 */
@JsonPropertyOrder({
  LanguageSearchResponse.JSON_PROPERTY_DATA,
  LanguageSearchResponse.JSON_PROPERTY_OFFSET,
  LanguageSearchResponse.JSON_PROPERTY_HAS_MORE,
  LanguageSearchResponse.JSON_PROPERTY_LIMIT
})
@JsonTypeName("Language_Search_Response")

public class LanguageSearchResponse {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<RestLanguage> data = new ArrayList<>();
  ...
  @JsonCreator
  public LanguageSearchResponse(
    @JsonProperty(JSON_PROPERTY_DATA) List<RestLanguage> data, 
  ...
  public List<RestLanguage> getData() {
    return data;
  }
  ...
  public boolean equals(Object o) {
    ...
    LanguageSearchResponse languageSearchResponse = (LanguageSearchResponse) o;
    return Objects.equals(this.data, languageSearchResponse.data) &&
        Objects.equals(this.offset, languageSearchResponse.offset) &&
        Objects.equals(this.hasMore, languageSearchResponse.hasMore) &&
        Objects.equals(this.limit, languageSearchResponse.limit);
  }
  ...
  public String toString() {
    ...
    sb.append("class LanguageSearchResponse {\n");
