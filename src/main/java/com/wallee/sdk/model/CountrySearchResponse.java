 ...
 */
@JsonPropertyOrder({
  CountrySearchResponse.JSON_PROPERTY_DATA,
  CountrySearchResponse.JSON_PROPERTY_OFFSET,
  CountrySearchResponse.JSON_PROPERTY_HAS_MORE,
  CountrySearchResponse.JSON_PROPERTY_LIMIT
})
@JsonTypeName("Country_Search_Response")

public class CountrySearchResponse {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<RestCountry> data = new ArrayList<>();
  ...
  @JsonCreator
  public CountrySearchResponse(
    @JsonProperty(JSON_PROPERTY_DATA) List<RestCountry> data, 
  ...
  public boolean equals(Object o) {
    ...
    CountrySearchResponse countrySearchResponse = (CountrySearchResponse) o;
    return Objects.equals(this.data, countrySearchResponse.data) &&
        Objects.equals(this.offset, countrySearchResponse.offset) &&
        Objects.equals(this.hasMore, countrySearchResponse.hasMore) &&
        Objects.equals(this.limit, countrySearchResponse.limit);
  }
  ...
  public String toString() {
    ...
    sb.append("class CountrySearchResponse {\n");
