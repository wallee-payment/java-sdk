...
public class Address {
  ...
  public Address gender(@javax.annotation.Nullable Gender gender) {
  ...
  public Address legalOrganizationForm(@javax.annotation.Nullable LegalOrganizationForm legalOrganizationForm) {
