...
public class PaymentLinkActive {
  ...
  public PaymentLinkActive shippingAddressHandlingMode(@javax.annotation.Nullable PaymentLinkAddressHandlingMode shippingAddressHandlingMode) {
  ...
  public PaymentLinkActive allowedRedirectionDomains(@javax.annotation.Nullable Set<String> allowedRedirectionDomains) {
  ...
  public PaymentLinkActive language(@javax.annotation.Nullable String language) {
  ...
  public PaymentLinkActive version(@javax.annotation.Nonnull Integer version) {
  ...
  public PaymentLinkActive availableFrom(@javax.annotation.Nullable OffsetDateTime availableFrom) {
  ...
  public PaymentLinkActive lineItems(@javax.annotation.Nullable List<LineItemCreate> lineItems) {
  ...
  public PaymentLinkActive availableUntil(@javax.annotation.Nullable OffsetDateTime availableUntil) {
  ...
  public PaymentLinkActive name(@javax.annotation.Nullable String name) {
  ...
  public PaymentLinkActive currency(@javax.annotation.Nullable String currency) {
  ...
  public PaymentLinkActive maximalNumberOfTransactions(@javax.annotation.Nullable Integer maximalNumberOfTransactions) {
  ...
  public PaymentLinkActive allowedPaymentMethodConfigurations(@javax.annotation.Nullable Set<PaymentMethodConfiguration> allowedPaymentMethodConfigurations) {
  ...
  public PaymentLinkActive appliedSpaceView(@javax.annotation.Nullable Long appliedSpaceView) {
  ...
  public PaymentLinkActive billingAddressHandlingMode(@javax.annotation.Nullable PaymentLinkAddressHandlingMode billingAddressHandlingMode) {
  ...
  public PaymentLinkActive state(@javax.annotation.Nullable CreationEntityState state) {
