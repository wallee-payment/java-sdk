 ...
 */
@JsonPropertyOrder({
  DunningFlowLevelProcessor.JSON_PROPERTY_FEATURE,
  DunningFlowLevelProcessor.JSON_PROPERTY_NAME,
  DunningFlowLevelProcessor.JSON_PROPERTY_DESCRIPTION,
  DunningFlowLevelProcessor.JSON_PROPERTY_ID
})

public class DunningFlowLevelProcessor {
  ...
  public DunningFlowLevelProcessor() {
  }
  /**
  ...
  public DunningFlowLevelProcessor feature(@javax.annotation.Nullable Feature feature) {
  ...
  public boolean equals(Object o) {
    ...
    DunningFlowLevelProcessor dunningFlowLevelProcessor = (DunningFlowLevelProcessor) o;
    return Objects.equals(this.feature, dunningFlowLevelProcessor.feature) &&
        Objects.equals(this.name, dunningFlowLevelProcessor.name) &&
        Objects.equals(this.description, dunningFlowLevelProcessor.description) &&
        Objects.equals(this.id, dunningFlowLevelProcessor.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(feature, name, description, id);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DunningFlowLevelProcessor {\n");
