 ...
 */
@JsonPropertyOrder({
  TokenSearchResponse.JSON_PROPERTY_DATA,
  TokenSearchResponse.JSON_PROPERTY_OFFSET,
  TokenSearchResponse.JSON_PROPERTY_HAS_MORE,
  TokenSearchResponse.JSON_PROPERTY_LIMIT
})
@JsonTypeName("Token_Search_Response")
...
public class TokenSearchResponse {
  ...
  @JsonCreator
  public TokenSearchResponse(
    @JsonProperty(JSON_PROPERTY_DATA) List<Token> data, 
  ...
  public boolean equals(Object o) {
    ...
    TokenSearchResponse tokenSearchResponse = (TokenSearchResponse) o;
    return Objects.equals(this.data, tokenSearchResponse.data) &&
        Objects.equals(this.offset, tokenSearchResponse.offset) &&
        Objects.equals(this.hasMore, tokenSearchResponse.hasMore) &&
        Objects.equals(this.limit, tokenSearchResponse.limit);
  }
  ...
  public String toString() {
    ...
    sb.append("class TokenSearchResponse {\n");
