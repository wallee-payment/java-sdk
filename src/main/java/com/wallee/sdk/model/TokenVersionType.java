 ...
 */
@JsonPropertyOrder({
  TokenVersionType.JSON_PROPERTY_FEATURE,
  TokenVersionType.JSON_PROPERTY_NAME,
  TokenVersionType.JSON_PROPERTY_DESCRIPTION,
  TokenVersionType.JSON_PROPERTY_ID
})

public class TokenVersionType {
  ...
  public TokenVersionType feature(@javax.annotation.Nullable Feature feature) {
  ...
  public boolean equals(Object o) {
    ...
    TokenVersionType tokenVersionType = (TokenVersionType) o;
    return Objects.equals(this.feature, tokenVersionType.feature) &&
        Objects.equals(this.name, tokenVersionType.name) &&
        Objects.equals(this.description, tokenVersionType.description) &&
        Objects.equals(this.id, tokenVersionType.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class TokenVersionType {\n");
