 ...
 */
@JsonPropertyOrder({
  TenantDatabase.JSON_PROPERTY_NAME,
  TenantDatabase.JSON_PROPERTY_ID,
  TenantDatabase.JSON_PROPERTY_VERSION
})
...
public class TenantDatabase {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, tenantDatabase.name) &&
        Objects.equals(this.id, tenantDatabase.id) &&
