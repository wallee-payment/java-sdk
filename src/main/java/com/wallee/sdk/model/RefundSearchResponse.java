 ...
 */
@JsonPropertyOrder({
  RefundSearchResponse.JSON_PROPERTY_DATA,
  RefundSearchResponse.JSON_PROPERTY_OFFSET,
  RefundSearchResponse.JSON_PROPERTY_HAS_MORE,
  RefundSearchResponse.JSON_PROPERTY_LIMIT
})
@JsonTypeName("Refund_Search_Response")

public class RefundSearchResponse {
  public static final String JSON_PROPERTY_DATA = "data";
  private List<Refund> data = new ArrayList<>();
  ...
  */
  @JsonCreator
  public RefundSearchResponse(
    @JsonProperty(JSON_PROPERTY_DATA) List<Refund> data, 
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RefundSearchResponse refundSearchResponse = (RefundSearchResponse) o;
    return Objects.equals(this.data, refundSearchResponse.data) &&
        Objects.equals(this.offset, refundSearchResponse.offset) &&
        Objects.equals(this.hasMore, refundSearchResponse.hasMore) &&
        Objects.equals(this.limit, refundSearchResponse.limit);
  }
  ...
  public String toString() {
    ...
    sb.append("class RefundSearchResponse {\n");
