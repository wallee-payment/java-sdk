 ...
 */
@JsonPropertyOrder({
  MetricSearchResponse.JSON_PROPERTY_DATA,
  MetricSearchResponse.JSON_PROPERTY_OFFSET,
  MetricSearchResponse.JSON_PROPERTY_HAS_MORE,
  MetricSearchResponse.JSON_PROPERTY_LIMIT
})
@JsonTypeName("Metric_Search_Response")

public class MetricSearchResponse {
  public static final String JSON_PROPERTY_DATA = "data";
  private List<SubscriptionMetric> data = new ArrayList<>();
  ...
  */
  @JsonCreator
  public MetricSearchResponse(
    @JsonProperty(JSON_PROPERTY_DATA) List<SubscriptionMetric> data, 
  ...
  **/
  ...
  public List<SubscriptionMetric> getData() {
    return data;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, metricSearchResponse.data) &&
        Objects.equals(this.offset, metricSearchResponse.offset) &&
        Objects.equals(this.hasMore, metricSearchResponse.hasMore) &&
        Objects.equals(this.limit, metricSearchResponse.limit);
  }
