...
public class AbstractSubscriberUpdate {
  ...
  public AbstractSubscriberUpdate reference(@javax.annotation.Nullable String reference) {
  ...
  public AbstractSubscriberUpdate additionalAllowedPaymentMethodConfigurations(@javax.annotation.Nullable List<Long> additionalAllowedPaymentMethodConfigurations) {
  ...
  public AbstractSubscriberUpdate metaData(@javax.annotation.Nullable Map<String, String> metaData) {
  ...
  public AbstractSubscriberUpdate emailAddress(@javax.annotation.Nullable String emailAddress) {
  ...
  public AbstractSubscriberUpdate disallowedPaymentMethodConfigurations(@javax.annotation.Nullable List<Long> disallowedPaymentMethodConfigurations) {
  ...
  public AbstractSubscriberUpdate description(@javax.annotation.Nullable String description) {
  ...
  public AbstractSubscriberUpdate shippingAddress(@javax.annotation.Nullable AddressCreate shippingAddress) {
  ...
  public AbstractSubscriberUpdate language(@javax.annotation.Nullable String language) {
  ...
  public AbstractSubscriberUpdate billingAddress(@javax.annotation.Nullable AddressCreate billingAddress) {
