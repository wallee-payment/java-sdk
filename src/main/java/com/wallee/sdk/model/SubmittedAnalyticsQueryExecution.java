...
import com.wallee.sdk.model.FacadeUserFriendlyQueryStatusModel;
...
public class SubmittedAnalyticsQueryExecution {
  ...
  public SubmittedAnalyticsQueryExecution status(@javax.annotation.Nullable FacadeUserFriendlyQueryStatusModel status) {
  ...
  @JsonProperty(JSON_PROPERTY_STATUS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStatus(@javax.annotation.Nullable FacadeUserFriendlyQueryStatusModel status) {
    this.status = status;
  }
