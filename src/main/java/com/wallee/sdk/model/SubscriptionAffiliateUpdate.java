...
public class SubscriptionAffiliateUpdate {
  ...
  public SubscriptionAffiliateUpdate metaData(@javax.annotation.Nullable Map<String, String> metaData) {
  ...
  public SubscriptionAffiliateUpdate name(@javax.annotation.Nullable String name) {
  ...
  public SubscriptionAffiliateUpdate language(@javax.annotation.Nullable String language) {
  ...
  public SubscriptionAffiliateUpdate state(@javax.annotation.Nullable CreationEntityState state) {
  ...
  public SubscriptionAffiliateUpdate version(@javax.annotation.Nonnull Integer version) {
