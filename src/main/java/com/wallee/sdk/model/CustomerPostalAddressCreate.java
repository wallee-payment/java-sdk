 ...
 */
@JsonPropertyOrder({
  CustomerPostalAddressCreate.JSON_PROPERTY_COUNTRY,
  CustomerPostalAddressCreate.JSON_PROPERTY_MOBILE_PHONE_NUMBER,
  CustomerPostalAddressCreate.JSON_PROPERTY_GENDER,
  CustomerPostalAddressCreate.JSON_PROPERTY_ORGANIZATION_NAME,
  CustomerPostalAddressCreate.JSON_PROPERTY_CITY,
  CustomerPostalAddressCreate.JSON_PROPERTY_COMMERCIAL_REGISTER_NUMBER,
  CustomerPostalAddressCreate.JSON_PROPERTY_SOCIAL_SECURITY_NUMBER,
  CustomerPostalAddressCreate.JSON_PROPERTY_GIVEN_NAME,
  CustomerPostalAddressCreate.JSON_PROPERTY_POSTCODE,
  CustomerPostalAddressCreate.JSON_PROPERTY_LEGAL_ORGANIZATION_FORM,
  CustomerPostalAddressCreate.JSON_PROPERTY_SALES_TAX_NUMBER,
  CustomerPostalAddressCreate.JSON_PROPERTY_DATE_OF_BIRTH,
  CustomerPostalAddressCreate.JSON_PROPERTY_DEPENDENT_LOCALITY,
  CustomerPostalAddressCreate.JSON_PROPERTY_EMAIL_ADDRESS,
  CustomerPostalAddressCreate.JSON_PROPERTY_PHONE_NUMBER,
  CustomerPostalAddressCreate.JSON_PROPERTY_SORTING_CODE,
  CustomerPostalAddressCreate.JSON_PROPERTY_STREET,
  CustomerPostalAddressCreate.JSON_PROPERTY_FAMILY_NAME,
  CustomerPostalAddressCreate.JSON_PROPERTY_POSTAL_STATE,
  CustomerPostalAddressCreate.JSON_PROPERTY_SALUTATION
})
@JsonTypeName("CustomerPostalAddress.Create")
...
public class CustomerPostalAddressCreate {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.country, customerPostalAddressCreate.country) &&
        ...
        Objects.equals(this.city, customerPostalAddressCreate.city) &&
