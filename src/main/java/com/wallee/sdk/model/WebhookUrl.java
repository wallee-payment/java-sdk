 ...
 */
@JsonPropertyOrder({
  WebhookUrl.JSON_PROPERTY_LINKED_SPACE_ID,
  WebhookUrl.JSON_PROPERTY_APPLICATION_MANAGED,
  WebhookUrl.JSON_PROPERTY_NAME,
  WebhookUrl.JSON_PROPERTY_PLANNED_PURGE_DATE,
  WebhookUrl.JSON_PROPERTY_ID,
  WebhookUrl.JSON_PROPERTY_STATE,
  WebhookUrl.JSON_PROPERTY_VERSION,
  WebhookUrl.JSON_PROPERTY_URL
})
...
public class WebhookUrl {
  ...
  public WebhookUrl state(@javax.annotation.Nullable CreationEntityState state) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.linkedSpaceId, webhookUrl.linkedSpaceId) &&
        Objects.equals(this.applicationManaged, webhookUrl.applicationManaged) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(linkedSpaceId, applicationManaged, name, plannedPurgeDate, id, state, version, url);
  }
