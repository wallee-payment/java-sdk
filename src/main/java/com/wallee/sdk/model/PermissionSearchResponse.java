 ...
 */
@JsonPropertyOrder({
  PermissionSearchResponse.JSON_PROPERTY_DATA,
  PermissionSearchResponse.JSON_PROPERTY_OFFSET,
  PermissionSearchResponse.JSON_PROPERTY_HAS_MORE,
  PermissionSearchResponse.JSON_PROPERTY_LIMIT
})
@JsonTypeName("Permission_Search_Response")
...
public class PermissionSearchResponse {
  ...
  public PermissionSearchResponse() {
  }
  /**
  ...
  */
  @JsonCreator
  public PermissionSearchResponse(
    @JsonProperty(JSON_PROPERTY_DATA) List<Permission> data, 
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PermissionSearchResponse permissionSearchResponse = (PermissionSearchResponse) o;
    return Objects.equals(this.data, permissionSearchResponse.data) &&
        Objects.equals(this.offset, permissionSearchResponse.offset) &&
        Objects.equals(this.hasMore, permissionSearchResponse.hasMore) &&
        Objects.equals(this.limit, permissionSearchResponse.limit);
  }
  ...
  public String toString() {
    ...
    sb.append("class PermissionSearchResponse {\n");
