 ...
 */
@JsonPropertyOrder({
  ApplicationUserUpdate.JSON_PROPERTY_REQUEST_LIMIT,
  ApplicationUserUpdate.JSON_PROPERTY_NAME,
  ApplicationUserUpdate.JSON_PROPERTY_STATE,
  ApplicationUserUpdate.JSON_PROPERTY_VERSION
})
@JsonTypeName("ApplicationUser.Update")
...
public class ApplicationUserUpdate {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requestLimit, applicationUserUpdate.requestLimit) &&
        Objects.equals(this.name, applicationUserUpdate.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(requestLimit, name, state, version);
  }
