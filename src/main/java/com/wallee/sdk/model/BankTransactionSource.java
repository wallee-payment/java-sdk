 ...
 */
@JsonPropertyOrder({
  BankTransactionSource.JSON_PROPERTY_NAME,
  BankTransactionSource.JSON_PROPERTY_DESCRIPTION,
  BankTransactionSource.JSON_PROPERTY_ID
})

public class BankTransactionSource {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BankTransactionSource bankTransactionSource = (BankTransactionSource) o;
    return Objects.equals(this.name, bankTransactionSource.name) &&
        Objects.equals(this.description, bankTransactionSource.description) &&
        Objects.equals(this.id, bankTransactionSource.id);
  }
