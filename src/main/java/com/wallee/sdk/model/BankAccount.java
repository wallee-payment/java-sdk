...
import com.wallee.sdk.model.BankAccountState;
...
@JsonPropertyOrder({
  ...
  BankAccount.JSON_PROPERTY_LINKED_SPACE_ID,
  BankAccount.JSON_PROPERTY_PLANNED_PURGE_DATE,
  BankAccount.JSON_PROPERTY_DESCRIPTION,
  BankAccount.JSON_PROPERTY_ID,
  BankAccount.JSON_PROPERTY_STATE,
  BankAccount.JSON_PROPERTY_TYPE,
  BankAccount.JSON_PROPERTY_VERSION
})
...
public class BankAccount {
  ...
  public BankAccount state(@javax.annotation.Nullable BankAccountState state) {
  ...
  @JsonProperty(JSON_PROPERTY_STATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setState(@javax.annotation.Nullable BankAccountState state) {
    this.state = state;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(identifier, linkedSpaceId, plannedPurgeDate, description, id, state, type, version);
  }
