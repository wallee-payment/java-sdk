 ...
 */
@JsonPropertyOrder({
  PaymentTerminalConfiguration.JSON_PROPERTY_LINKED_SPACE_ID,
  PaymentTerminalConfiguration.JSON_PROPERTY_NAME,
  PaymentTerminalConfiguration.JSON_PROPERTY_PLANNED_PURGE_DATE,
  PaymentTerminalConfiguration.JSON_PROPERTY_ID,
  PaymentTerminalConfiguration.JSON_PROPERTY_STATE,
  PaymentTerminalConfiguration.JSON_PROPERTY_TYPE,
  PaymentTerminalConfiguration.JSON_PROPERTY_VERSION
})
...
public class PaymentTerminalConfiguration {
  ...
  @javax.annotation.Nullable
  private PaymentTerminalConfigurationState state;
  ...
  public PaymentTerminalConfiguration state(@javax.annotation.Nullable PaymentTerminalConfigurationState state) {
  ...
  @JsonProperty(JSON_PROPERTY_STATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setState(@javax.annotation.Nullable PaymentTerminalConfigurationState state) {
    this.state = state;
  }

  public PaymentTerminalConfiguration type(@javax.annotation.Nullable PaymentTerminalType type) {
  ...
  @JsonProperty(JSON_PROPERTY_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setType(@javax.annotation.Nullable PaymentTerminalType type) {
    this.type = type;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.linkedSpaceId, paymentTerminalConfiguration.linkedSpaceId) &&
        ...
        Objects.equals(this.id, paymentTerminalConfiguration.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(linkedSpaceId, name, plannedPurgeDate, id, state, type, version);
  }
