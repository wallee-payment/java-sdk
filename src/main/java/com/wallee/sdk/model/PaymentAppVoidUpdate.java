...
public class PaymentAppVoidUpdate {
  ...
  public PaymentAppVoidUpdate reference(@javax.annotation.Nullable String reference) {
  ...
  public PaymentAppVoidUpdate targetState(@javax.annotation.Nullable PaymentAppVoidTargetState targetState) {
  ...
  @JsonProperty(JSON_PROPERTY_TARGET_STATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTargetState(@javax.annotation.Nullable PaymentAppVoidTargetState targetState) {
    this.targetState = targetState;
  }

  public PaymentAppVoidUpdate failureReason(@javax.annotation.Nullable Long failureReason) {
