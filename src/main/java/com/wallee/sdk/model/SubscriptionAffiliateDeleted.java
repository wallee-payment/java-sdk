 ...
 */
@JsonPropertyOrder({
  SubscriptionAffiliateDeleted.JSON_PROPERTY_REFERENCE,
  SubscriptionAffiliateDeleted.JSON_PROPERTY_LINKED_SPACE_ID,
  SubscriptionAffiliateDeleted.JSON_PROPERTY_META_DATA,
  SubscriptionAffiliateDeleted.JSON_PROPERTY_NAME,
  SubscriptionAffiliateDeleted.JSON_PROPERTY_PLANNED_PURGE_DATE,
  SubscriptionAffiliateDeleted.JSON_PROPERTY_EXTERNAL_ID,
  SubscriptionAffiliateDeleted.JSON_PROPERTY_LANGUAGE,
  SubscriptionAffiliateDeleted.JSON_PROPERTY_ID,
  SubscriptionAffiliateDeleted.JSON_PROPERTY_STATE,
  SubscriptionAffiliateDeleted.JSON_PROPERTY_VERSION
})
@JsonTypeName("SubscriptionAffiliate.Deleted")

public class SubscriptionAffiliateDeleted {
  ...
  public SubscriptionAffiliateDeleted state(@javax.annotation.Nullable CreationEntityState state) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.reference, subscriptionAffiliateDeleted.reference) &&
        ...
        Objects.equals(this.externalId, subscriptionAffiliateDeleted.externalId) &&
