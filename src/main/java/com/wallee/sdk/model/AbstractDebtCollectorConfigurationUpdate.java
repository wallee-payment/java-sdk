...
public class AbstractDebtCollectorConfigurationUpdate {
  ...
  public AbstractDebtCollectorConfigurationUpdate skipReviewEnabled(@javax.annotation.Nullable Boolean skipReviewEnabled) {
  ...
  public AbstractDebtCollectorConfigurationUpdate name(@javax.annotation.Nullable String name) {
  ...
  public AbstractDebtCollectorConfigurationUpdate enabledSpaceViews(@javax.annotation.Nullable Set<Long> enabledSpaceViews) {
  ...
  public AbstractDebtCollectorConfigurationUpdate state(@javax.annotation.Nullable CreationEntityState state) {
  ...
  public AbstractDebtCollectorConfigurationUpdate conditions(@javax.annotation.Nullable List<DebtCollectorCondition> conditions) {
  ...
  public AbstractDebtCollectorConfigurationUpdate priority(@javax.annotation.Nullable Integer priority) {
