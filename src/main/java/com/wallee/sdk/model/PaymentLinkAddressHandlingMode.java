...
public enum PaymentLinkAddressHandlingMode {
  ...
  PaymentLinkAddressHandlingMode(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PaymentLinkAddressHandlingMode fromValue(String value) {
    for (PaymentLinkAddressHandlingMode b : PaymentLinkAddressHandlingMode.values()) {
