 ...
 */
@JsonPropertyOrder({
  SubscriptionProductComponentReference.JSON_PROPERTY_LINKED_SPACE_ID,
  SubscriptionProductComponentReference.JSON_PROPERTY_NAME,
  SubscriptionProductComponentReference.JSON_PROPERTY_PLANNED_PURGE_DATE,
  SubscriptionProductComponentReference.JSON_PROPERTY_ID,
  SubscriptionProductComponentReference.JSON_PROPERTY_STATE,
  SubscriptionProductComponentReference.JSON_PROPERTY_SKU,
  SubscriptionProductComponentReference.JSON_PROPERTY_VERSION
})
...
public class SubscriptionProductComponentReference {
  ...
  @javax.annotation.Nullable
  private SubscriptionProductComponentReferenceState state;
  ...
  public SubscriptionProductComponentReference() {
  }
  /**
  ...
  public SubscriptionProductComponentReference state(@javax.annotation.Nullable SubscriptionProductComponentReferenceState state) {
  ...
  @JsonProperty(JSON_PROPERTY_STATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setState(@javax.annotation.Nullable SubscriptionProductComponentReferenceState state) {
    this.state = state;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.linkedSpaceId, subscriptionProductComponentReference.linkedSpaceId) &&
        ...
        Objects.equals(this.id, subscriptionProductComponentReference.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(linkedSpaceId, name, plannedPurgeDate, id, state, sku, version);
  }
