...
public class SubscriptionProductComponentReference extends Indentable {
    ...
    @JsonProperty("state")
    protected SubscriptionProductComponentReferenceState state;
    ...
    public String toString() {
        ...
        return "class SubscriptionProductComponentReference { \n" +
