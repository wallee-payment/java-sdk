 ...
 */
@JsonPropertyOrder({
  TransactionPending.JSON_PROPERTY_CUSTOMER_EMAIL_ADDRESS,
  TransactionPending.JSON_PROPERTY_SHIPPING_METHOD,
  TransactionPending.JSON_PROPERTY_INVOICE_MERCHANT_REFERENCE,
  TransactionPending.JSON_PROPERTY_SUCCESS_URL,
  TransactionPending.JSON_PROPERTY_TIME_ZONE,
  TransactionPending.JSON_PROPERTY_LANGUAGE,
  TransactionPending.JSON_PROPERTY_TOKENIZATION_MODE,
  TransactionPending.JSON_PROPERTY_ALLOWED_PAYMENT_METHOD_BRANDS,
  TransactionPending.JSON_PROPERTY_COMPLETION_BEHAVIOR,
  TransactionPending.JSON_PROPERTY_TOKEN,
  TransactionPending.JSON_PROPERTY_LINE_ITEMS,
  TransactionPending.JSON_PROPERTY_META_DATA,
  TransactionPending.JSON_PROPERTY_CUSTOMER_ID,
  TransactionPending.JSON_PROPERTY_SHIPPING_ADDRESS,
  TransactionPending.JSON_PROPERTY_CURRENCY,
  TransactionPending.JSON_PROPERTY_BILLING_ADDRESS,
  TransactionPending.JSON_PROPERTY_MERCHANT_REFERENCE,
  TransactionPending.JSON_PROPERTY_ALLOWED_PAYMENT_METHOD_CONFIGURATIONS,
  TransactionPending.JSON_PROPERTY_FAILED_URL,
  TransactionPending.JSON_PROPERTY_VERSION
})
@JsonTypeName("Transaction.Pending")
...
public class TransactionPending {
  ...
  **/
  ...
  public TransactionPending addAllowedPaymentMethodBrandsItem(Long allowedPaymentMethodBrandsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customerEmailAddress, transactionPending.customerEmailAddress) &&
        ...
        Objects.equals(this.allowedPaymentMethodBrands, transactionPending.allowedPaymentMethodBrands) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customerEmailAddress, shippingMethod, invoiceMerchantReference, successUrl, timeZone, language, tokenizationMode, allowedPaymentMethodBrands, completionBehavior, token, lineItems, metaData, customerId, shippingAddress, currency, billingAddress, merchantReference, allowedPaymentMethodConfigurations, failedUrl, version);
  }
