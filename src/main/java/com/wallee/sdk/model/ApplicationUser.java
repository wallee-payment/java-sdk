...
public class ApplicationUser {
  ...
  public ApplicationUser state(@javax.annotation.Nullable CreationEntityState state) {
  ...
  public ApplicationUser userType(@javax.annotation.Nullable UserType userType) {
