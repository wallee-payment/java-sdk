 ...
 */
@JsonPropertyOrder({
  TwoFactorAuthenticationType.JSON_PROPERTY_FEATURE,
  TwoFactorAuthenticationType.JSON_PROPERTY_ICON,
  TwoFactorAuthenticationType.JSON_PROPERTY_NAME,
  TwoFactorAuthenticationType.JSON_PROPERTY_DESCRIPTION,
  TwoFactorAuthenticationType.JSON_PROPERTY_ID
})
...
public class TwoFactorAuthenticationType {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.feature, twoFactorAuthenticationType.feature) &&
        Objects.equals(this.icon, twoFactorAuthenticationType.icon) &&
        Objects.equals(this.name, twoFactorAuthenticationType.name) &&
        Objects.equals(this.description, twoFactorAuthenticationType.description) &&
        Objects.equals(this.id, twoFactorAuthenticationType.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(feature, icon, name, description, id);
  }
