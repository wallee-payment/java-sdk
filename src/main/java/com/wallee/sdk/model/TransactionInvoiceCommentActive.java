 ...
 */
@JsonPropertyOrder({
  TransactionInvoiceCommentActive.JSON_PROPERTY_CONTENT,
  TransactionInvoiceCommentActive.JSON_PROPERTY_VERSION
})
@JsonTypeName("TransactionInvoiceComment.Active")
