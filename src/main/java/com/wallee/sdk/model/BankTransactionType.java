 ...
 */
@JsonPropertyOrder({
  BankTransactionType.JSON_PROPERTY_NAME,
  BankTransactionType.JSON_PROPERTY_DESCRIPTION,
  BankTransactionType.JSON_PROPERTY_ID
})
...
public class BankTransactionType {
  ...
  public boolean equals(Object o) {
    ...
    BankTransactionType bankTransactionType = (BankTransactionType) o;
    return Objects.equals(this.name, bankTransactionType.name) &&
        Objects.equals(this.description, bankTransactionType.description) &&
        Objects.equals(this.id, bankTransactionType.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class BankTransactionType {\n");
