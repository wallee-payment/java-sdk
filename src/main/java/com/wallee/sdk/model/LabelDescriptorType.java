 ...
 */
@JsonPropertyOrder({
  LabelDescriptorType.JSON_PROPERTY_NAME,
  LabelDescriptorType.JSON_PROPERTY_DESCRIPTION,
  LabelDescriptorType.JSON_PROPERTY_ID
})
...
public class LabelDescriptorType {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LabelDescriptorType labelDescriptorType = (LabelDescriptorType) o;
    return Objects.equals(this.name, labelDescriptorType.name) &&
        Objects.equals(this.description, labelDescriptorType.description) &&
        Objects.equals(this.id, labelDescriptorType.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class LabelDescriptorType {\n");
