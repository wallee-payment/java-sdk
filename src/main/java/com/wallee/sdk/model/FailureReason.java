 ...
 */
@JsonPropertyOrder({
  FailureReason.JSON_PROPERTY_NAME,
  FailureReason.JSON_PROPERTY_DESCRIPTION,
  FailureReason.JSON_PROPERTY_ID,
  FailureReason.JSON_PROPERTY_CATEGORY
})
...
public class FailureReason {
  ...
  public FailureReason category(@javax.annotation.Nullable FailureCategory category) {
  ...
  @JsonProperty(JSON_PROPERTY_CATEGORY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCategory(@javax.annotation.Nullable FailureCategory category) {
    this.category = category;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, failureReason.name) &&
        Objects.equals(this.description, failureReason.description) &&
        Objects.equals(this.id, failureReason.id) &&
        Objects.equals(this.category, failureReason.category);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, id, category);
  }
