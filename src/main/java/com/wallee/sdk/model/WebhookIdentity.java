 ...
 */
@JsonPropertyOrder({
  WebhookIdentity.JSON_PROPERTY_LINKED_SPACE_ID,
  WebhookIdentity.JSON_PROPERTY_NAME,
  WebhookIdentity.JSON_PROPERTY_PLANNED_PURGE_DATE,
  WebhookIdentity.JSON_PROPERTY_ID,
  WebhookIdentity.JSON_PROPERTY_STATE,
  WebhookIdentity.JSON_PROPERTY_VERSION
})
...
public class WebhookIdentity {
  ...
  public WebhookIdentity state(@javax.annotation.Nullable CreationEntityState state) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(linkedSpaceId, name, plannedPurgeDate, id, state, version);
  }
