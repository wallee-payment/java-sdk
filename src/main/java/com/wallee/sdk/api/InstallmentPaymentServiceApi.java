...
public class InstallmentPaymentServiceApi {
	private ApiClient apiClient;

	public InstallmentPaymentServiceApi(ApiClient apiClient) {
	...
	private com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		String localVarPath = "/installment-payment/count".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call createInstallmentPaymentCall(Long spaceId, Long transactionId, Long installmentPlanConfiguration, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/installment-payment/createInstallmentPayment".replaceAll("\\{format\\}","json");
		...
		localVarQueryParams.addAll(apiClient.parameterToPairs("", "installmentPlanConfiguration", installmentPlanConfiguration));
	...
	public ApiResponse<InstallmentPayment> createInstallmentPaymentWithHttpInfo(Long spaceId, Long transactionId, Long installmentPlanConfiguration) throws ApiException {
		com.squareup.okhttp.Call call = createInstallmentPaymentCall(spaceId, transactionId, installmentPlanConfiguration, null, null);
	...
	private com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/installment-payment/read".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/installment-payment/search".replaceAll("\\{format\\}","json");
