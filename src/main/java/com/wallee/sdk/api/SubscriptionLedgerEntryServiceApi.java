...
public class SubscriptionLedgerEntryServiceApi {
	private ApiClient apiClient;

	public SubscriptionLedgerEntryServiceApi(ApiClient apiClient) {
	...
	private com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		String localVarPath = "/subscription-ledger-entry/count".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call createCall(Long spaceId, SubscriptionLedgerEntryCreate entry, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/subscription-ledger-entry/create".replaceAll("\\{format\\}","json");
	...
	public ApiResponse<SubscriptionLedgerEntry> createWithHttpInfo(Long spaceId, SubscriptionLedgerEntryCreate entry) throws ApiException {
		com.squareup.okhttp.Call call = createCall(spaceId, entry, null, null);
	...
	private com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/subscription-ledger-entry/read".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/subscription-ledger-entry/search".replaceAll("\\{format\\}","json");
