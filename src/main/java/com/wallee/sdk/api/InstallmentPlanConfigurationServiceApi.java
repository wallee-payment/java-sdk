...
public class InstallmentPlanConfigurationServiceApi {
	private ApiClient apiClient;

	public InstallmentPlanConfigurationServiceApi(ApiClient apiClient) {
	...
	private com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		String localVarPath = "/installment-plan-configuration/count".replaceAll("\\{format\\}","json");
	 ...
	 *
	 * @param filter The filter which restricts the installment plan configurations which are used to calculate the count. (required)
	 * @return Long
	...
	private com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/installment-plan-configuration/read".replaceAll("\\{format\\}","json");
	 ...
	 * @param spaceId  (required)
	 *
	 * @param id The id of the installment plan configuration which should be returned. (required)
	 * @return InstallmentPlanConfiguration
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public InstallmentPlanConfiguration read(Long spaceId, Long id) throws ApiException {
		ApiResponse<InstallmentPlanConfiguration> resp = readWithHttpInfo(spaceId, id);
		return resp.getData();
	}
	 ...
	 *
	 * @param id The id of the installment plan configuration which should be returned. (required)
	 * @return ApiResponse&lt;InstallmentPlanConfiguration&gt;
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public ApiResponse<InstallmentPlanConfiguration> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
		com.squareup.okhttp.Call call = readCall(spaceId, id, null, null);
		Type localVarReturnType = new TypeToken<InstallmentPlanConfiguration>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 * @throws ApiException If fail to process the API call, e.g. serializing the request body object
	 */
	public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<InstallmentPlanConfiguration> callback) throws ApiException {
	...
	private com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/installment-plan-configuration/search".replaceAll("\\{format\\}","json");
	 ...
	 * @param spaceId  (required)
	 *
	 * @param query The query restricts the installment plan configurations which are returned by the search. (required)
	 * @return List&lt;InstallmentPlanConfiguration&gt;
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public List<InstallmentPlanConfiguration> search(Long spaceId, EntityQuery query) throws ApiException {
		ApiResponse<List<InstallmentPlanConfiguration>> resp = searchWithHttpInfo(spaceId, query);
		return resp.getData();
	}
	 ...
	 *
	 * @param query The query restricts the installment plan configurations which are returned by the search. (required)
	 * @return ApiResponse&lt;List&lt;InstallmentPlanConfiguration&gt;&gt;
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public ApiResponse<List<InstallmentPlanConfiguration>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
		com.squareup.okhttp.Call call = searchCall(spaceId, query, null, null);
		Type localVarReturnType = new TypeToken<List<InstallmentPlanConfiguration>>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 * @throws ApiException If fail to process the API call, e.g. serializing the request body object
	 */
	public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<InstallmentPlanConfiguration>> callback) throws ApiException {
