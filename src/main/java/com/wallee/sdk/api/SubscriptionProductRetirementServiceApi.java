...
public class SubscriptionProductRetirementServiceApi {
	private ApiClient apiClient;

	public SubscriptionProductRetirementServiceApi(ApiClient apiClient) {
	...
	private com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		String localVarPath = "/subscription-product-retirement/count".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call createCall(Long spaceId, SubscriptionProductRetirementCreate retirement, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/subscription-product-retirement/create".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/subscription-product-retirement/read".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/subscription-product-retirement/search".replaceAll("\\{format\\}","json");
