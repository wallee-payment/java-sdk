...
public class ChargeFlowLevelServiceApi {
	private ApiClient apiClient;

	public ChargeFlowLevelServiceApi(ApiClient apiClient) {
	...
	private com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		String localVarPath = "/charge-flow-level/count".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/charge-flow-level/read".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/charge-flow-level/search".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call sendMessageCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody = null;
		...
		// create path and map variables
		String localVarPath = "/charge-flow-level/sendMessage".replaceAll("\\{format\\}","json");
	...
	public ApiResponse<ChargeFlowLevel> sendMessageWithHttpInfo(Long spaceId, Long id) throws ApiException {
		com.squareup.okhttp.Call call = sendMessageCall(spaceId, id, null, null);
		Type localVarReturnType = new TypeToken<ChargeFlowLevel>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
