...
import com.wallee.sdk.model.InstallmentPaymentSlice;
...
public class InstallmentPaymentSliceServiceApi {
	private ApiClient apiClient;

	public InstallmentPaymentSliceServiceApi(ApiClient apiClient) {
	...
	private com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		String localVarPath = "/installment-payment-slice/count".replaceAll("\\{format\\}","json");
	 ...
	 *
	 * @param filter The filter which restricts the installment payment slices which are used to calculate the count. (required)
	 * @return Long
	...
	private com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/installment-payment-slice/read".replaceAll("\\{format\\}","json");
	 ...
	 * @param spaceId  (required)
	 *
	 * @param id The id of the installment payment slice which should be returned. (required)
	 * @return InstallmentPaymentSlice
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public InstallmentPaymentSlice read(Long spaceId, Long id) throws ApiException {
		ApiResponse<InstallmentPaymentSlice> resp = readWithHttpInfo(spaceId, id);
		return resp.getData();
	}
	 ...
	 *
	 * @param id The id of the installment payment slice which should be returned. (required)
	 * @return ApiResponse&lt;InstallmentPaymentSlice&gt;
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public ApiResponse<InstallmentPaymentSlice> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
		com.squareup.okhttp.Call call = readCall(spaceId, id, null, null);
		Type localVarReturnType = new TypeToken<InstallmentPaymentSlice>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 * @throws ApiException If fail to process the API call, e.g. serializing the request body object
	 */
	public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<InstallmentPaymentSlice> callback) throws ApiException {
	...
	private com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/installment-payment-slice/search".replaceAll("\\{format\\}","json");
	 ...
	 * @param spaceId  (required)
	 *
	 * @param query The query restricts the installment payment slices which are returned by the search. (required)
	 * @return List&lt;InstallmentPaymentSlice&gt;
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public List<InstallmentPaymentSlice> search(Long spaceId, EntityQuery query) throws ApiException {
		ApiResponse<List<InstallmentPaymentSlice>> resp = searchWithHttpInfo(spaceId, query);
		return resp.getData();
	}
	 ...
	 *
	 * @param query The query restricts the installment payment slices which are returned by the search. (required)
	 * @return ApiResponse&lt;List&lt;InstallmentPaymentSlice&gt;&gt;
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public ApiResponse<List<InstallmentPaymentSlice>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
		com.squareup.okhttp.Call call = searchCall(spaceId, query, null, null);
		Type localVarReturnType = new TypeToken<List<InstallmentPaymentSlice>>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 * @throws ApiException If fail to process the API call, e.g. serializing the request body object
	 */
	public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<InstallmentPaymentSlice>> callback) throws ApiException {
