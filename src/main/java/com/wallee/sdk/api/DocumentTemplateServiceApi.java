...
public class DocumentTemplateServiceApi {
	private ApiClient apiClient;

	public DocumentTemplateServiceApi(ApiClient apiClient) {
	...
	private com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		String localVarPath = "/document-template/count".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/document-template/read".replaceAll("\\{format\\}","json");
	 ...
	 * @param spaceId  (required)
	 *
	 * @param id The id of the document template which should be returned. (required)
	 * @return DocumentTemplate
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public DocumentTemplate read(Long spaceId, Long id) throws ApiException {
		ApiResponse<DocumentTemplate> resp = readWithHttpInfo(spaceId, id);
		return resp.getData();
	}
	 ...
	 *
	 * @param id The id of the document template which should be returned. (required)
	 * @return ApiResponse&lt;DocumentTemplate&gt;
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public ApiResponse<DocumentTemplate> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
		com.squareup.okhttp.Call call = readCall(spaceId, id, null, null);
		Type localVarReturnType = new TypeToken<DocumentTemplate>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 * @throws ApiException If fail to process the API call, e.g. serializing the request body object
	 */
	public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<DocumentTemplate> callback) throws ApiException {
	...
	private com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/document-template/search".replaceAll("\\{format\\}","json");
	 ...
	 * @param spaceId  (required)
	 *
	 * @param query The query restricts the document templates which are returned by the search. (required)
	 * @return List&lt;DocumentTemplate&gt;
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public List<DocumentTemplate> search(Long spaceId, EntityQuery query) throws ApiException {
		ApiResponse<List<DocumentTemplate>> resp = searchWithHttpInfo(spaceId, query);
		return resp.getData();
	}
	 ...
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public ApiResponse<List<DocumentTemplate>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
		com.squareup.okhttp.Call call = searchCall(spaceId, query, null, null);
		Type localVarReturnType = new TypeToken<List<DocumentTemplate>>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 * @throws ApiException If fail to process the API call, e.g. serializing the request body object
	 */
	public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<DocumentTemplate>> callback) throws ApiException {
