...
public class InstallmentPlanSliceConfigurationServiceApi {
	private ApiClient apiClient;

	public InstallmentPlanSliceConfigurationServiceApi(ApiClient apiClient) {
	...
	private com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		String localVarPath = "/installment-plan-slice-configuration/count".replaceAll("\\{format\\}","json");
	 ...
	 *
	 * @param filter The filter which restricts the installment plan slice configurations which are used to calculate the count. (required)
	 * @return Long
	...
	private com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/installment-plan-slice-configuration/read".replaceAll("\\{format\\}","json");
	 ...
	 * @param spaceId  (required)
	 *
	 * @param id The id of the installment plan slice configuration which should be returned. (required)
	 * @return InstallmentPlanSliceConfiguration
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public InstallmentPlanSliceConfiguration read(Long spaceId, Long id) throws ApiException {
		ApiResponse<InstallmentPlanSliceConfiguration> resp = readWithHttpInfo(spaceId, id);
		return resp.getData();
	}
	 ...
	 *
	 * @param id The id of the installment plan slice configuration which should be returned. (required)
	 * @return ApiResponse&lt;InstallmentPlanSliceConfiguration&gt;
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public ApiResponse<InstallmentPlanSliceConfiguration> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
		com.squareup.okhttp.Call call = readCall(spaceId, id, null, null);
		Type localVarReturnType = new TypeToken<InstallmentPlanSliceConfiguration>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 * @throws ApiException If fail to process the API call, e.g. serializing the request body object
	 */
	public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<InstallmentPlanSliceConfiguration> callback) throws ApiException {
	...
	private com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/installment-plan-slice-configuration/search".replaceAll("\\{format\\}","json");
	 ...
	 * @param spaceId  (required)
	 *
	 * @param query The query restricts the installment plan slice configurations which are returned by the search. (required)
	 * @return List&lt;InstallmentPlanSliceConfiguration&gt;
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public List<InstallmentPlanSliceConfiguration> search(Long spaceId, EntityQuery query) throws ApiException {
		ApiResponse<List<InstallmentPlanSliceConfiguration>> resp = searchWithHttpInfo(spaceId, query);
		return resp.getData();
	}
	 ...
	 *
	 * @param query The query restricts the installment plan slice configurations which are returned by the search. (required)
	 * @return ApiResponse&lt;List&lt;InstallmentPlanSliceConfiguration&gt;&gt;
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public ApiResponse<List<InstallmentPlanSliceConfiguration>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
		com.squareup.okhttp.Call call = searchCall(spaceId, query, null, null);
		Type localVarReturnType = new TypeToken<List<InstallmentPlanSliceConfiguration>>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 * @throws ApiException If fail to process the API call, e.g. serializing the request body object
	 */
	public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<InstallmentPlanSliceConfiguration>> callback) throws ApiException {
