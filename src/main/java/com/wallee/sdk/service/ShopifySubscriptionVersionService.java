...
public class ShopifySubscriptionVersionService {
    private ApiClient apiClient;

    public ShopifySubscriptionVersionService(ApiClient apiClient) {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-subscription-version-service--count">Count Documentation</a>
     */
    public com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/shopify-subscription-version/count";
     ...
     * Build call for read
     * @param spaceId  (required)
     * @param id The id of the Shopify subscription version which should be returned. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-subscription-version-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/shopify-subscription-version/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-subscription-version-service--read">Read Documentation</a>
     */
    public ShopifySubscriptionVersion read(Long spaceId, Long id) throws ApiException {
        ApiResponse<ShopifySubscriptionVersion> resp = readWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-subscription-version-service--read">Read Documentation</a>
     */
    public ApiResponse<ShopifySubscriptionVersion> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-subscription-version-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<ShopifySubscriptionVersion> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param query The query restricts the Shopify subscription versions which are returned by the search. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-subscription-version-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/shopify-subscription-version/search";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-subscription-version-service--search">Search Documentation</a>
     */
    public List<ShopifySubscriptionVersion> search(Long spaceId, EntityQuery query) throws ApiException {
        ApiResponse<List<ShopifySubscriptionVersion>> resp = searchWithHttpInfo(spaceId, query);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param query The query restricts the Shopify subscription versions which are returned by the search. (required)
     * @return ApiResponse&lt;List&lt;ShopifySubscriptionVersion&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-subscription-version-service--search">Search Documentation</a>
     */
    public ApiResponse<List<ShopifySubscriptionVersion>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
        com.squareup.okhttp.Call call = searchValidateBeforeCall(spaceId, query, null, null);
        Type localVarReturnType = new TypeToken<List<ShopifySubscriptionVersion>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-subscription-version-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<ShopifySubscriptionVersion>> callback) throws ApiException {
