...
public class TokenVersionService {
    ...
    /**
     * Build call for activeVersion
     * @param spaceId  (required)
     * @param id The id of a token for which you want to look up the current active token version. (required)
     ...
     */
    public com.squareup.okhttp.Call activeVersionCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/token-version/active-version";
    ...
    private com.squareup.okhttp.Call activeVersionValidateBeforeCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'spaceId' is set
        if (spaceId == null) {
            throw new ApiException("Missing the required parameter 'spaceId' when calling activeVersion(Async)");
        }
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling activeVersion(Async)");
        }
        

        com.squareup.okhttp.Call call = activeVersionCall(spaceId, id, progressListener, progressRequestListener);
        return call;
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#token-version-service--active-version">Active Version Documentation</a>
     */
    public TokenVersion activeVersion(Long spaceId, Long id) throws ApiException {
        ApiResponse<TokenVersion> resp = activeVersionWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param id The id of a token for which you want to look up the current active token version. (required)
     * @return ApiResponse&lt;TokenVersion&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#token-version-service--active-version">Active Version Documentation</a>
     */
    public ApiResponse<TokenVersion> activeVersionWithHttpInfo(Long spaceId, Long id) throws ApiException {
        com.squareup.okhttp.Call call = activeVersionValidateBeforeCall(spaceId, id, null, null);
        Type localVarReturnType = new TypeToken<TokenVersion>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Active Version (asynchronously)
     * Returns the token version which is currently active given by the token id. In case no token version is active the method will return null.
     * @param spaceId  (required)
     * @param id The id of a token for which you want to look up the current active token version. (required)
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#token-version-service--active-version">Active Version Documentation</a>
     */
    public com.squareup.okhttp.Call activeVersionAsync(Long spaceId, Long id, final ApiCallback<TokenVersion> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = activeVersionValidateBeforeCall(spaceId, id, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TokenVersion>(){}.getType();
    ...
    public com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/token-version/count";
     ...
     * Build call for read
     * @param spaceId  (required)
     * @param id The id of the token version which should be returned. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/token-version/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#token-version-service--read">Read Documentation</a>
     */
    public TokenVersion read(Long spaceId, Long id) throws ApiException {
        ApiResponse<TokenVersion> resp = readWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#token-version-service--read">Read Documentation</a>
     */
    public ApiResponse<TokenVersion> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#token-version-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<TokenVersion> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param query The query restricts the token versions which are returned by the search. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/token-version/search";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#token-version-service--search">Search Documentation</a>
     */
    public List<TokenVersion> search(Long spaceId, EntityQuery query) throws ApiException {
        ApiResponse<List<TokenVersion>> resp = searchWithHttpInfo(spaceId, query);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#token-version-service--search">Search Documentation</a>
     */
    public ApiResponse<List<TokenVersion>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#token-version-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<TokenVersion>> callback) throws ApiException {
