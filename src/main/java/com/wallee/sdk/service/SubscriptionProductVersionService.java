...
public class SubscriptionProductVersionService {
    ...
    public HttpResponse activateForHttpResponse(Long spaceId, Long productVersionId) throws IOException {
        ServiceUtils.checkParam(spaceId == null, "spaceId", "activate");
        ServiceUtils.checkParam(productVersionId == null, "productVersionId", "activate");
        ...
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/subscription-product-version/activate")
                ...
                .queryParam("productVersionId", productVersionId);
    ...
    public HttpResponse countForHttpResponse(Long spaceId, EntityQueryFilter filter) throws IOException {
        return ServiceUtils.countForHttpResponse(spaceId, filter, false, apiClient, "/subscription-product-version/count");
    }

    public HttpResponse countForHttpResponse(Long spaceId, InputStream filter, String mediaType) throws IOException {
        return ServiceUtils.countForHttpResponse(spaceId, filter, mediaType, false, apiClient, "/subscription-product-version/count");
    }

    public HttpResponse countForHttpResponse(EntityQueryFilter filter, Long spaceId, Map<String, Object> params) throws IOException {
        return ServiceUtils.countForHttpResponse(filter, spaceId, params, apiClient, "/subscription-product-version/count");
    }
    ...
    public HttpResponse createForHttpResponse(Long spaceId, SubscriptionProductVersionPending entity) throws IOException {
        return ServiceUtils.createForHttpResponse(spaceId, entity, apiClient, "/subscription-product-version/create");
    }

    public HttpResponse createForHttpResponse(Long spaceId, InputStream entity, String mediaType) throws IOException {
        return ServiceUtils.createForHttpResponse(spaceId, entity, mediaType, apiClient, "/subscription-product-version/create");
    }
    ...
    public HttpResponse createForHttpResponse(Long spaceId, SubscriptionProductVersionPending entity, Map<String, Object> params) throws IOException {
        return ServiceUtils.createForHttpResponse(spaceId, entity, params, apiClient, "/subscription-product-version/create");
    }
    ...
    public HttpResponse readForHttpResponse(Long spaceId, Long id) throws IOException {
        return ServiceUtils.readForHttpResponse(spaceId, id, apiClient, "/subscription-product-version/read");
    }

    public HttpResponse readForHttpResponse(Long spaceId, Long id, Map<String, Object> params) throws IOException {
        return ServiceUtils.readForHttpResponse(spaceId, id, params, apiClient, "/subscription-product-version/read");
    }
