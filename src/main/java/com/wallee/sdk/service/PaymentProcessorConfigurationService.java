...
public class PaymentProcessorConfigurationService {
    private ApiClient apiClient;

    public PaymentProcessorConfigurationService(ApiClient apiClient) {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-processor-configuration-service--count">Count Documentation</a>
     */
    public com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/payment-processor-configuration/count";
     ...
     * Build call for read
     * @param spaceId  (required)
     * @param id The id of the payment processor configuration which should be returned. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-processor-configuration-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/payment-processor-configuration/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-processor-configuration-service--read">Read Documentation</a>
     */
    public PaymentProcessorConfiguration read(Long spaceId, Long id) throws ApiException {
        ApiResponse<PaymentProcessorConfiguration> resp = readWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param id The id of the payment processor configuration which should be returned. (required)
     * @return ApiResponse&lt;PaymentProcessorConfiguration&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-processor-configuration-service--read">Read Documentation</a>
     */
    public ApiResponse<PaymentProcessorConfiguration> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
        com.squareup.okhttp.Call call = readValidateBeforeCall(spaceId, id, null, null);
        Type localVarReturnType = new TypeToken<PaymentProcessorConfiguration>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-processor-configuration-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<PaymentProcessorConfiguration> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param query The query restricts the payment processor configuration which are returned by the search. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-processor-configuration-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/payment-processor-configuration/search";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-processor-configuration-service--search">Search Documentation</a>
     */
    public List<PaymentProcessorConfiguration> search(Long spaceId, EntityQuery query) throws ApiException {
        ApiResponse<List<PaymentProcessorConfiguration>> resp = searchWithHttpInfo(spaceId, query);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param query The query restricts the payment processor configuration which are returned by the search. (required)
     * @return ApiResponse&lt;List&lt;PaymentProcessorConfiguration&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-processor-configuration-service--search">Search Documentation</a>
     */
    public ApiResponse<List<PaymentProcessorConfiguration>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
        com.squareup.okhttp.Call call = searchValidateBeforeCall(spaceId, query, null, null);
        Type localVarReturnType = new TypeToken<List<PaymentProcessorConfiguration>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-processor-configuration-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<PaymentProcessorConfiguration>> callback) throws ApiException {
