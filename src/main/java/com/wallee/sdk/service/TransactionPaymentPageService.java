...
public class TransactionPaymentPageService {
  ...
  /**
    ...
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#transaction-payment-page-service--payment-page-url">Build Payment Page URL Documentation</a>
  ...
  /**
    ...
    **/
    ...
    public HttpResponse paymentPageUrlForHttpResponse(Long spaceId, Long id) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/transaction-payment-page/payment-page-url");
        if (spaceId != null) {
            String key = "spaceId";
