...
public class ChargeFlowLevelPaymentLinkService {
    ...
    public com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/charge-flow-level-payment-link/count";
     ...
     * Build call for read
     * @param spaceId  (required)
     * @param id The ID of the charge flow level payment link which should be returned. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/charge-flow-level-payment-link/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#charge-flow-level-payment-link-service--read">Read Documentation</a>
     */
    public ChargeFlowLevelPaymentLink read(Long spaceId, Long id) throws ApiException {
        ApiResponse<ChargeFlowLevelPaymentLink> resp = readWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param id The ID of the charge flow level payment link which should be returned. (required)
     * @return ApiResponse&lt;ChargeFlowLevelPaymentLink&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#charge-flow-level-payment-link-service--read">Read Documentation</a>
     */
    public ApiResponse<ChargeFlowLevelPaymentLink> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
        com.squareup.okhttp.Call call = readValidateBeforeCall(spaceId, id, null, null);
        Type localVarReturnType = new TypeToken<ChargeFlowLevelPaymentLink>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#charge-flow-level-payment-link-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<ChargeFlowLevelPaymentLink> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param query The query restricts the charge flow level payment links which are returned by the search. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/charge-flow-level-payment-link/search";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#charge-flow-level-payment-link-service--search">Search Documentation</a>
     */
    public List<ChargeFlowLevelPaymentLink> search(Long spaceId, EntityQuery query) throws ApiException {
        ApiResponse<List<ChargeFlowLevelPaymentLink>> resp = searchWithHttpInfo(spaceId, query);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param query The query restricts the charge flow level payment links which are returned by the search. (required)
     * @return ApiResponse&lt;List&lt;ChargeFlowLevelPaymentLink&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#charge-flow-level-payment-link-service--search">Search Documentation</a>
     */
    public ApiResponse<List<ChargeFlowLevelPaymentLink>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
        com.squareup.okhttp.Call call = searchValidateBeforeCall(spaceId, query, null, null);
        Type localVarReturnType = new TypeToken<List<ChargeFlowLevelPaymentLink>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#charge-flow-level-payment-link-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<ChargeFlowLevelPaymentLink>> callback) throws ApiException {
