...
public class ChargeFlowLevelPaymentLinkService {
  ...
  /**
    ...
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#charge-flow-level-payment-link-service--count">Count Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#charge-flow-level-payment-link-service--read">Read Documentation</a>
    ...
    **/
    public ChargeFlowLevelPaymentLink read(Long spaceId, Long id) throws IOException {
        ...
        if(returnType.equals("String")){
          return (ChargeFlowLevelPaymentLink) (Object) response.parseAsString();
        }
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#charge-flow-level-payment-link-service--search">Search Documentation</a>
    ...
    **/
    public List<ChargeFlowLevelPaymentLink> search(Long spaceId, EntityQuery query) throws IOException {
        ...
        if(returnType.equals("String")){
          return (List<ChargeFlowLevelPaymentLink>) (Object) response.parseAsString();
        }
  ...
  /**
    ...
    **/
    ...
    public HttpResponse searchForHttpResponse(Long spaceId, EntityQuery query) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/charge-flow-level-payment-link/search");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
