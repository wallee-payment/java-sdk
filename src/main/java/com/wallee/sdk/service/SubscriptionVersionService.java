...
public class SubscriptionVersionService {
    ...
    public com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/subscription-version/count";
    ...
    public com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscription-version/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-version-service--read">Read Documentation</a>
     */
    public SubscriptionVersion read(Long spaceId, Long id) throws ApiException {
        ApiResponse<SubscriptionVersion> resp = readWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-version-service--read">Read Documentation</a>
     */
    public ApiResponse<SubscriptionVersion> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-version-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<SubscriptionVersion> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscription-version/search";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-version-service--search">Search Documentation</a>
     */
    public List<SubscriptionVersion> search(Long spaceId, EntityQuery query) throws ApiException {
        ApiResponse<List<SubscriptionVersion>> resp = searchWithHttpInfo(spaceId, query);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param query The query restricts the subscriptions which are returned by the search. (required)
     * @return ApiResponse&lt;List&lt;SubscriptionVersion&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-version-service--search">Search Documentation</a>
     */
    public ApiResponse<List<SubscriptionVersion>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
        com.squareup.okhttp.Call call = searchValidateBeforeCall(spaceId, query, null, null);
        Type localVarReturnType = new TypeToken<List<SubscriptionVersion>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-version-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<SubscriptionVersion>> callback) throws ApiException {
