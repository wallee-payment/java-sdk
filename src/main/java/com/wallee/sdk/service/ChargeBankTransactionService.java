...
public class ChargeBankTransactionService {
    private ApiClient apiClient;

    public ChargeBankTransactionService(ApiClient apiClient) {
  ...
  /**
    ...
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#charge-bank-transaction-service--count">Count Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#charge-bank-transaction-service--read">Read Documentation</a>

    **/
    public ChargeBankTransaction read(Long spaceId, Long id) throws IOException {
        HttpResponse response = readForHttpResponse(spaceId, id);
        String returnType = "ChargeBankTransaction";
        if(returnType.equals("String")){
          return (ChargeBankTransaction) (Object) response.parseAsString();
        }
        TypeReference typeRef = new TypeReference<ChargeBankTransaction>() {};
        if (isNoBodyResponse(response)) {
            throw new WalleeSdkException(ErrorCode.ENTITY_NOT_FOUND, "Entity was not found for: " + typeRef.getType().getTypeName());
        }
        return (ChargeBankTransaction)apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }
  ...
  /**
    ...
    **/
    public ChargeBankTransaction read(Long spaceId, Long id, Map<String, Object> params) throws IOException {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#charge-bank-transaction-service--search">Search Documentation</a>

    **/
    public List<ChargeBankTransaction> search(Long spaceId, EntityQuery query) throws IOException {
        HttpResponse response = searchForHttpResponse(spaceId, query);
        String returnType = "List&lt;ChargeBankTransaction&gt;";
        if(returnType.equals("String")){
          return (List<ChargeBankTransaction>) (Object) response.parseAsString();
        }
        TypeReference typeRef = new TypeReference<List<ChargeBankTransaction>>() {};
        if (isNoBodyResponse(response)) {
            throw new WalleeSdkException(ErrorCode.ENTITY_NOT_FOUND, "Entity was not found for: " + typeRef.getType().getTypeName());
        }
        return (List<ChargeBankTransaction>)apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }
  ...
  /**
    ...
    **/
    public List<ChargeBankTransaction> search(Long spaceId, EntityQuery query, Map<String, Object> params) throws IOException {
