...
public class SubscriptionProductSetupFeeService {
    ...
    public com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/subscription-product-setup-fee/count";
     ...
     * @param spaceId  (required)
     * @param entity The setup fee object with the properties which should be created. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public com.squareup.okhttp.Call createCall(Long spaceId, ProductSetupFeeUpdate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = entity;

        // create path and map variables
        String localVarPath = "/subscription-product-setup-fee/create";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createValidateBeforeCall(Long spaceId, ProductSetupFeeUpdate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-setup-fee-service--create">Create Documentation</a>
     */
    public ProductSetupFee create(Long spaceId, ProductSetupFeeUpdate entity) throws ApiException {
        ApiResponse<ProductSetupFee> resp = createWithHttpInfo(spaceId, entity);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param entity The setup fee object with the properties which should be created. (required)
     * @return ApiResponse&lt;ProductSetupFee&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-setup-fee-service--create">Create Documentation</a>
     */
    public ApiResponse<ProductSetupFee> createWithHttpInfo(Long spaceId, ProductSetupFeeUpdate entity) throws ApiException {
        com.squareup.okhttp.Call call = createValidateBeforeCall(spaceId, entity, null, null);
        Type localVarReturnType = new TypeToken<ProductSetupFee>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-setup-fee-service--create">Create Documentation</a>
     */
    public com.squareup.okhttp.Call createAsync(Long spaceId, ProductSetupFeeUpdate entity, final ApiCallback<ProductSetupFee> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call deleteCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscription-product-setup-fee/delete";
     ...
     * Build call for read
     * @param spaceId  (required)
     * @param id The id of the setup fee which should be returned. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscription-product-setup-fee/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-setup-fee-service--read">Read Documentation</a>
     */
    public ProductSetupFee read(Long spaceId, Long id) throws ApiException {
        ApiResponse<ProductSetupFee> resp = readWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-setup-fee-service--read">Read Documentation</a>
     */
    public ApiResponse<ProductSetupFee> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-setup-fee-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<ProductSetupFee> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param query The query restricts the setup fees which are returned by the search. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscription-product-setup-fee/search";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-setup-fee-service--search">Search Documentation</a>
     */
    public List<ProductSetupFee> search(Long spaceId, EntityQuery query) throws ApiException {
        ApiResponse<List<ProductSetupFee>> resp = searchWithHttpInfo(spaceId, query);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param query The query restricts the setup fees which are returned by the search. (required)
     * @return ApiResponse&lt;List&lt;ProductSetupFee&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-setup-fee-service--search">Search Documentation</a>
     */
    public ApiResponse<List<ProductSetupFee>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
        com.squareup.okhttp.Call call = searchValidateBeforeCall(spaceId, query, null, null);
        Type localVarReturnType = new TypeToken<List<ProductSetupFee>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-setup-fee-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<ProductSetupFee>> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param entity The setup fee object with all the properties which should be updated. The id and the version are required properties. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public com.squareup.okhttp.Call updateCall(Long spaceId, ProductSetupFeeUpdate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = entity;

        // create path and map variables
        String localVarPath = "/subscription-product-setup-fee/update";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateValidateBeforeCall(Long spaceId, ProductSetupFeeUpdate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-setup-fee-service--update">Update Documentation</a>
     */
    public ProductSetupFee update(Long spaceId, ProductSetupFeeUpdate entity) throws ApiException {
        ApiResponse<ProductSetupFee> resp = updateWithHttpInfo(spaceId, entity);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-setup-fee-service--update">Update Documentation</a>
     */
    public ApiResponse<ProductSetupFee> updateWithHttpInfo(Long spaceId, ProductSetupFeeUpdate entity) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-setup-fee-service--update">Update Documentation</a>
     */
    public com.squareup.okhttp.Call updateAsync(Long spaceId, ProductSetupFeeUpdate entity, final ApiCallback<ProductSetupFee> callback) throws ApiException {
