...
public class SubscriptionProductSetupFeeService {
    ...
    public HttpResponse countForHttpResponse(Long spaceId, EntityQueryFilter filter) throws IOException {
        return ServiceUtils.countForHttpResponse(spaceId, filter, false, apiClient, "/subscription-product-setup-fee/count");
    }

    public HttpResponse countForHttpResponse(Long spaceId, InputStream filter, String mediaType) throws IOException {
        return ServiceUtils.countForHttpResponse(spaceId, filter, mediaType, false, apiClient, "/subscription-product-setup-fee/count");
    }

    public HttpResponse countForHttpResponse(EntityQueryFilter filter, Long spaceId, Map<String, Object> params) throws IOException {
        return ServiceUtils.countForHttpResponse(filter, spaceId, params, apiClient, "/subscription-product-setup-fee/count");
    }
    ...
    public ProductSetupFee create(Long spaceId, ProductSetupFeeUpdate entity) throws IOException {
        ...
        return apiClient.getObjectMapper().readValue(response.getContent(), new TypeReference<ProductSetupFee>() {
        });
    }
    ...
    public HttpResponse createForHttpResponse(Long spaceId, ProductSetupFeeUpdate entity) throws IOException {
        return ServiceUtils.createForHttpResponse(spaceId, entity, apiClient, "/subscription-product-setup-fee/create");
    }

    public HttpResponse createForHttpResponse(Long spaceId, InputStream entity, String mediaType) throws IOException {
        return ServiceUtils.createForHttpResponse(spaceId, entity, mediaType, apiClient, "/subscription-product-setup-fee/create");
    }
    ...
    public HttpResponse createForHttpResponse(Long spaceId, ProductSetupFeeUpdate entity, Map<String, Object> params) throws IOException {
        return ServiceUtils.createForHttpResponse(spaceId, entity, params, apiClient, "/subscription-product-setup-fee/create");
    }
    ...
    public HttpResponse deleteForHttpResponse(Long spaceId, Long id) throws IOException {
        return ServiceUtils.deleteForHttpResponse(spaceId, id, apiClient, "/subscription-product-setup-fee/delete");
    }

    public HttpResponse deleteForHttpResponse(Long spaceId, InputStream id, String mediaType) throws IOException {
        return ServiceUtils.deleteForHttpResponse(spaceId, id, mediaType, apiClient, "/subscription-product-setup-fee/delete");
    }

    public HttpResponse deleteForHttpResponse(Long spaceId, Long id, Map<String, Object> params) throws IOException {
        return ServiceUtils.deleteForHttpResponse(spaceId, id, params, apiClient, "/subscription-product-setup-fee/delete");
    }
    ...
    public HttpResponse readForHttpResponse(Long spaceId, Long id) throws IOException {
        return ServiceUtils.readForHttpResponse(spaceId, id, apiClient, "/subscription-product-setup-fee/read");
    }

    public HttpResponse readForHttpResponse(Long spaceId, Long id, Map<String, Object> params) throws IOException {
        return ServiceUtils.readForHttpResponse(spaceId, id, params, apiClient, "/subscription-product-setup-fee/read");
    }
    ...
    public List<ProductSetupFee> search(Long spaceId, EntityQuery query) throws IOException {
        ...
        return apiClient.getObjectMapper().readValue(response.getContent(), new TypeReference<List<ProductSetupFee>>() {
        });
    }
