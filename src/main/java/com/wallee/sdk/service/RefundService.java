...
public class RefundService {
	...
	private com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		String localVarPath = "/refund/count".replaceAll("\\{format\\}","json");
	...
	/* Build call for fail */
	private com.squareup.okhttp.Call failCall(Long spaceId, Long refundId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/refund/fail".replaceAll("\\{format\\}","json");

		List<Pair> localVarQueryParams = new ArrayList<Pair>();
		localVarQueryParams.addAll(apiClient.parameterToPairs("", "spaceId", spaceId));

		localVarQueryParams.addAll(apiClient.parameterToPairs("", "refundId", refundId));
	...
	public ApiResponse<Refund> failWithHttpInfo(Long spaceId, Long refundId) throws ApiException {
		com.squareup.okhttp.Call call = failCall(spaceId, refundId, null, null);
	...
	private com.squareup.okhttp.Call getRefundDocumentCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody = null;
		...
		// create path and map variables
		String localVarPath = "/refund/getRefundDocument".replaceAll("\\{format\\}","json");
	...
	public ApiResponse<RenderedDocument> getRefundDocumentWithHttpInfo(Long spaceId, Long id) throws ApiException {
		com.squareup.okhttp.Call call = getRefundDocumentCall(spaceId, id, null, null);
	...
	private com.squareup.okhttp.Call getRefundDocumentWithTargetMediaTypeCall(Long spaceId, Long id, Long targetMediaTypeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody = null;
		...
		// create path and map variables
		String localVarPath = "/refund/getRefundDocumentWithTargetMediaType".replaceAll("\\{format\\}","json");
	...
	public ApiResponse<RenderedDocument> getRefundDocumentWithTargetMediaTypeWithHttpInfo(Long spaceId, Long id, Long targetMediaTypeId) throws ApiException {
		com.squareup.okhttp.Call call = getRefundDocumentWithTargetMediaTypeCall(spaceId, id, targetMediaTypeId, null, null);
		Type localVarReturnType = new TypeToken<RenderedDocument>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	...
	private com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/refund/read".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call refundCall(Long spaceId, RefundCreate refund, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/refund/refund".replaceAll("\\{format\\}","json");
	...
	public ApiResponse<Refund> refundWithHttpInfo(Long spaceId, RefundCreate refund) throws ApiException {
		com.squareup.okhttp.Call call = refundCall(spaceId, refund, null, null);
		Type localVarReturnType = new TypeToken<Refund>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	...
	private com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/refund/search".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call succeedCall(Long spaceId, Long refundId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody = null;
		...
		// create path and map variables
		String localVarPath = "/refund/succeed".replaceAll("\\{format\\}","json");
	...
	public ApiResponse<Refund> succeedWithHttpInfo(Long spaceId, Long refundId) throws ApiException {
		com.squareup.okhttp.Call call = succeedCall(spaceId, refundId, null, null);
		Type localVarReturnType = new TypeToken<Refund>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
