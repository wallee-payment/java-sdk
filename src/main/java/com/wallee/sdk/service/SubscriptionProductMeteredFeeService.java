...
public class SubscriptionProductMeteredFeeService {
    ...
    public com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/subscription-product-metered-fee/count";
     ...
     * @param spaceId  (required)
     * @param entity The metered fee object with the properties which should be created. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public com.squareup.okhttp.Call createCall(Long spaceId, ProductMeteredFeeUpdate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = entity;

        // create path and map variables
        String localVarPath = "/subscription-product-metered-fee/create";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createValidateBeforeCall(Long spaceId, ProductMeteredFeeUpdate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-metered-fee-service--create">Create Documentation</a>
     */
    public ProductMeteredFee create(Long spaceId, ProductMeteredFeeUpdate entity) throws ApiException {
        ApiResponse<ProductMeteredFee> resp = createWithHttpInfo(spaceId, entity);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param entity The metered fee object with the properties which should be created. (required)
     * @return ApiResponse&lt;ProductMeteredFee&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-metered-fee-service--create">Create Documentation</a>
     */
    public ApiResponse<ProductMeteredFee> createWithHttpInfo(Long spaceId, ProductMeteredFeeUpdate entity) throws ApiException {
        com.squareup.okhttp.Call call = createValidateBeforeCall(spaceId, entity, null, null);
        Type localVarReturnType = new TypeToken<ProductMeteredFee>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-metered-fee-service--create">Create Documentation</a>
     */
    public com.squareup.okhttp.Call createAsync(Long spaceId, ProductMeteredFeeUpdate entity, final ApiCallback<ProductMeteredFee> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call deleteCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscription-product-metered-fee/delete";
     ...
     * Build call for read
     * @param spaceId  (required)
     * @param id The id of the metered fee which should be returned. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscription-product-metered-fee/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-metered-fee-service--read">Read Documentation</a>
     */
    public ProductMeteredFee read(Long spaceId, Long id) throws ApiException {
        ApiResponse<ProductMeteredFee> resp = readWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-metered-fee-service--read">Read Documentation</a>
     */
    public ApiResponse<ProductMeteredFee> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-metered-fee-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<ProductMeteredFee> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param query The query restricts the metered fees which are returned by the search. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscription-product-metered-fee/search";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-metered-fee-service--search">Search Documentation</a>
     */
    public List<ProductMeteredFee> search(Long spaceId, EntityQuery query) throws ApiException {
        ApiResponse<List<ProductMeteredFee>> resp = searchWithHttpInfo(spaceId, query);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param query The query restricts the metered fees which are returned by the search. (required)
     * @return ApiResponse&lt;List&lt;ProductMeteredFee&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-metered-fee-service--search">Search Documentation</a>
     */
    public ApiResponse<List<ProductMeteredFee>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
        com.squareup.okhttp.Call call = searchValidateBeforeCall(spaceId, query, null, null);
        Type localVarReturnType = new TypeToken<List<ProductMeteredFee>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-metered-fee-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<ProductMeteredFee>> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param entity The metered fee object with all the properties which should be updated. The id and the version are required properties. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public com.squareup.okhttp.Call updateCall(Long spaceId, ProductMeteredFeeUpdate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = entity;

        // create path and map variables
        String localVarPath = "/subscription-product-metered-fee/update";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateValidateBeforeCall(Long spaceId, ProductMeteredFeeUpdate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-metered-fee-service--update">Update Documentation</a>
     */
    public ProductMeteredFee update(Long spaceId, ProductMeteredFeeUpdate entity) throws ApiException {
        ApiResponse<ProductMeteredFee> resp = updateWithHttpInfo(spaceId, entity);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-metered-fee-service--update">Update Documentation</a>
     */
    public ApiResponse<ProductMeteredFee> updateWithHttpInfo(Long spaceId, ProductMeteredFeeUpdate entity) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-product-metered-fee-service--update">Update Documentation</a>
     */
    public com.squareup.okhttp.Call updateAsync(Long spaceId, ProductMeteredFeeUpdate entity, final ApiCallback<ProductMeteredFee> callback) throws ApiException {
