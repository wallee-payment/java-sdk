...
public class ChargeAttemptService {
  ...
  /**
    ...
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#charge-attempt-service--count">Count Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#charge-attempt-service--read">Read Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#charge-attempt-service--search">Search Documentation</a>

    **/
    public List<ChargeAttempt> search(Long spaceId, EntityQuery query) throws IOException {
        HttpResponse response = searchForHttpResponse(spaceId, query);
        String returnType = "List&lt;ChargeAttempt&gt;";
        if(returnType.equals("String")){
          return (List<ChargeAttempt>) (Object) response.parseAsString();
        }
        TypeReference typeRef = new TypeReference<List<ChargeAttempt>>() {};
        if (isNoBodyResponse(response)) {
            throw new WalleeSdkException(ErrorCode.ENTITY_NOT_FOUND, "Entity was not found for: " + typeRef.getType().getTypeName());
        }
        return (List<ChargeAttempt>)apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }
