...
public class ShopifySubscriptionProductService {
    ...
    public HttpResponse countForHttpResponse(Long spaceId, EntityQueryFilter filter) throws IOException {
        return ServiceUtils.countForHttpResponse(spaceId, filter, false, apiClient, "/shopify-subscription-product/count");
    }

    public HttpResponse countForHttpResponse(Long spaceId, InputStream filter, String mediaType) throws IOException {
        return ServiceUtils.countForHttpResponse(spaceId, filter, mediaType, false, apiClient, "/shopify-subscription-product/count");
    }

    public HttpResponse countForHttpResponse(EntityQueryFilter filter, Long spaceId, Map<String, Object> params) throws IOException {
        return ServiceUtils.countForHttpResponse(filter, spaceId, params, apiClient, "/shopify-subscription-product/count");
    }
    ...
    public ShopifySubscriptionProduct create(Long spaceId, ShopifySubscriptionProductCreate entity) throws IOException {
        ...
        return apiClient.getObjectMapper().readValue(response.getContent(), new TypeReference<ShopifySubscriptionProduct>(){});
    }
    ...
    public HttpResponse createForHttpResponse(Long spaceId, ShopifySubscriptionProductCreate entity) throws IOException {
        return ServiceUtils.createForHttpResponse(spaceId, entity, apiClient, "/shopify-subscription-product/create");
    }

    public HttpResponse createForHttpResponse(Long spaceId, InputStream entity, String mediaType) throws IOException {
        return ServiceUtils.createForHttpResponse(spaceId, entity, mediaType, apiClient, "/shopify-subscription-product/create");
    }

    public HttpResponse createForHttpResponse(Long spaceId, ShopifySubscriptionProductCreate entity, Map<String, Object> params) throws IOException {
        return ServiceUtils.createForHttpResponse(spaceId, entity, params, apiClient, "/shopify-subscription-product/create");
    }
    ...
    public HttpResponse readForHttpResponse(Long spaceId, Long id) throws IOException {
        return ServiceUtils.readForHttpResponse(spaceId, id, apiClient, "/shopify-subscription-product/read");
    }

    public HttpResponse readForHttpResponse(Long spaceId, Long id, Map<String, Object> params) throws IOException {
        return ServiceUtils.readForHttpResponse(spaceId, id, params, apiClient, "/shopify-subscription-product/read");
    }
    ...
    public List<ShopifySubscriptionProduct> search(Long spaceId, EntityQuery query) throws IOException {
        ...
        return apiClient.getObjectMapper().readValue(response.getContent(), new TypeReference<List<ShopifySubscriptionProduct>>(){});
    }
    ...
    public HttpResponse updateForHttpResponse(Long spaceId, ShopifySubscriptionProductActive entity) throws IOException {
    ...
    public HttpResponse updateForHttpResponse(Long spaceId, ShopifySubscriptionProductActive entity, Map<String, Object> params) throws IOException {
        ServiceUtils.checkParam(spaceId == null, "spaceId", "update");
        ServiceUtils.checkParam(entity == null, "entity", "update");
