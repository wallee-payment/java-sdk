...
import com.wallee.sdk.model.ChargeFlowListResponse;
import com.wallee.sdk.model.ChargeFlowSearchResponse;
...
public class ChargeFlowsService extends BaseApi {

  public ChargeFlowsService(ApiClient apiClient) {
    super(apiClient);
  }
   ...
   * @return ChargeFlowListResponse
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentChargeFlows">List all charge flows Documentation</a>
   */
  ...
  public ChargeFlowListResponse getPaymentChargeFlows(Long space, Long after, Long before, Set<String> expand, Integer limit, SortingOrder order, Map<String, String> additionalHeaders) throws ApiException {
    ...
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getPaymentChargeFlows");
    }
    
    // create path and map variables
    String localVarPath = "/payment/charge-flows";
    ...
    TypeReference<ChargeFlowListResponse> localVarReturnType = new TypeReference<ChargeFlowListResponse>() {};
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentChargeFlowsId">Retrieve a charge flow Documentation</a>
   */
  ...
  public ChargeFlow getPaymentChargeFlowsId(Long id, Long space, Set<String> expand, Map<String, String> additionalHeaders) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getPaymentChargeFlowsId");
    }
    
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getPaymentChargeFlowsId");
    }
    ...
    TypeReference<ChargeFlow> localVarReturnType = new TypeReference<ChargeFlow>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
   ...
   * @return ChargeFlowSearchResponse
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentChargeFlowsSearch">Search charge flows Documentation</a>
   */
  ...
  public ChargeFlowSearchResponse getPaymentChargeFlowsSearch(Long space, Set<String> expand, Integer limit, Integer offset, String order, String query, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getPaymentChargeFlowsSearch");
    }
    
    // create path and map variables
    String localVarPath = "/payment/charge-flows/search";
    ...
    TypeReference<ChargeFlowSearchResponse> localVarReturnType = new TypeReference<ChargeFlowSearchResponse>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
