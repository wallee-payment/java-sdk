...
import com.wallee.sdk.model.DeliveryIndicationListResponse;
import com.wallee.sdk.model.DeliveryIndicationSearchResponse;
...
public class DeliveryIndicationsService extends BaseApi {

  public DeliveryIndicationsService(ApiClient apiClient) {
    super(apiClient);
  }
   ...
   * @return DeliveryIndicationListResponse
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentDeliveryIndications">List all delivery indications Documentation</a>
   */
  ...
  public DeliveryIndicationListResponse getPaymentDeliveryIndications(Long space, Long after, Long before, Set<String> expand, Integer limit, SortingOrder order, Map<String, String> additionalHeaders) throws ApiException {
    ...
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getPaymentDeliveryIndications");
    }
    
    // create path and map variables
    String localVarPath = "/payment/delivery-indications";
    ...
    TypeReference<DeliveryIndicationListResponse> localVarReturnType = new TypeReference<DeliveryIndicationListResponse>() {};
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentDeliveryIndicationsId">Retrieve a delivery indication Documentation</a>
   */
  ...
  public DeliveryIndication getPaymentDeliveryIndicationsId(Long id, Long space, Set<String> expand, Map<String, String> additionalHeaders) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getPaymentDeliveryIndicationsId");
    }
    
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getPaymentDeliveryIndicationsId");
    }
    ...
    TypeReference<DeliveryIndication> localVarReturnType = new TypeReference<DeliveryIndication>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
   ...
   * @return DeliveryIndicationSearchResponse
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentDeliveryIndicationsSearch">Search delivery indications Documentation</a>
   */
  ...
  public DeliveryIndicationSearchResponse getPaymentDeliveryIndicationsSearch(Long space, Set<String> expand, Integer limit, Integer offset, String order, String query, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getPaymentDeliveryIndicationsSearch");
    }
    
    // create path and map variables
    String localVarPath = "/payment/delivery-indications/search";
    ...
    TypeReference<DeliveryIndicationSearchResponse> localVarReturnType = new TypeReference<DeliveryIndicationSearchResponse>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#postPaymentDeliveryIndicationsIdMarkNotSuitable">Mark a delivery indication as not suitable. Documentation</a>
   */
  ...
  public DeliveryIndication postPaymentDeliveryIndicationsIdMarkNotSuitable(Long id, Long space, Set<String> expand, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling postPaymentDeliveryIndicationsIdMarkNotSuitable");
    }
    
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling postPaymentDeliveryIndicationsIdMarkNotSuitable");
    }
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#postPaymentDeliveryIndicationsIdMarkSuitable">Mark a delivery indication as suitable. Documentation</a>
   */
  ...
  public DeliveryIndication postPaymentDeliveryIndicationsIdMarkSuitable(Long id, Long space, Set<String> expand, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling postPaymentDeliveryIndicationsIdMarkSuitable");
    }
    
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling postPaymentDeliveryIndicationsIdMarkSuitable");
    }
