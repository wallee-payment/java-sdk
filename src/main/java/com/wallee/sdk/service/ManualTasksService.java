...
import com.wallee.sdk.model.ManualTask;
import com.wallee.sdk.model.ManualTaskListResponse;
import com.wallee.sdk.model.ManualTaskSearchResponse;
...
public class ManualTasksService extends BaseApi {

  public ManualTasksService(ApiClient apiClient) {
    super(apiClient);
  }
   ...
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getManualTasks">List all manual tasks Documentation</a>
   */
  ...
  public ManualTaskListResponse getManualTasks(Long space, Long after, Long before, Set<String> expand, Integer limit, SortingOrder order, Map<String, String> additionalHeaders) throws ApiException {
    ...
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getManualTasks");
    }
    
    // create path and map variables
    String localVarPath = "/manual-tasks";
    ...
    TypeReference<ManualTaskListResponse> localVarReturnType = new TypeReference<ManualTaskListResponse>() {};
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getManualTasksId">Retrieve a manual task Documentation</a>
   */
  ...
  public ManualTask getManualTasksId(Long id, Long space, Set<String> expand, Map<String, String> additionalHeaders) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getManualTasksId");
    }
    
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getManualTasksId");
    }
    ...
    TypeReference<ManualTask> localVarReturnType = new TypeReference<ManualTask>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getManualTasksIdNotification">Retrieve a manual task&#39;s notification message Documentation</a>
   */
  ...
  public String getManualTasksIdNotification(Long id, Long space, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getManualTasksIdNotification");
    }
    
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getManualTasksIdNotification");
    }
   ...
   * @return ManualTaskSearchResponse
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getManualTasksSearch">Search manual tasks Documentation</a>
   */
  ...
  public ManualTaskSearchResponse getManualTasksSearch(Long space, Set<String> expand, Integer limit, Integer offset, String order, String query, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getManualTasksSearch");
    }
    
    // create path and map variables
    String localVarPath = "/manual-tasks/search";
    ...
    TypeReference<ManualTaskSearchResponse> localVarReturnType = new TypeReference<ManualTaskSearchResponse>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#postManualTasksIdActionActionId">Process a manual task&#39;s action Documentation</a>
   */
  ...
  public void postManualTasksIdActionActionId(Long id, Long actionId, Long space, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling postManualTasksIdActionActionId");
    }
    
    // verify the required parameter 'actionId' is set
    if (actionId == null) {
      throw new ApiException(400, "Missing the required parameter 'actionId' when calling postManualTasksIdActionActionId");
    }
    
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling postManualTasksIdActionActionId");
    }
