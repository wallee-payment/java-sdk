...
import com.wallee.sdk.model.TokenListResponse;
import com.wallee.sdk.model.TokenSearchResponse;
...
public class TokensService extends BaseApi {

  public TokensService(ApiClient apiClient) {
    super(apiClient);
  }
   ...
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#deletePaymentTokensId">Delete a token Documentation</a>
   */
  ...
  public void deletePaymentTokensId(Long id, Long space, Map<String, String> additionalHeaders) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling deletePaymentTokensId");
    }
    
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling deletePaymentTokensId");
    }
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentTokens">List all tokens Documentation</a>
   */
  ...
  public TokenListResponse getPaymentTokens(Long space, Long after, Long before, Set<String> expand, Integer limit, SortingOrder order, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getPaymentTokens");
    }
    ...
    TypeReference<TokenListResponse> localVarReturnType = new TypeReference<TokenListResponse>() {};
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentTokensId">Retrieve a token Documentation</a>
   */
  ...
  public Token getPaymentTokensId(Long id, Long space, Set<String> expand, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getPaymentTokensId");
    }
    
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getPaymentTokensId");
    }
    ...
    TypeReference<Token> localVarReturnType = new TypeReference<Token>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentTokensIdActiveVersion">Retrieve the active token version Documentation</a>
   */
  ...
  public TokenVersion getPaymentTokensIdActiveVersion(Long id, Long space, Set<String> expand, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getPaymentTokensIdActiveVersion");
    }
    
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getPaymentTokensIdActiveVersion");
    }
    ...
    TypeReference<TokenVersion> localVarReturnType = new TypeReference<TokenVersion>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentTokensSearch">Search tokens Documentation</a>
   */
  ...
  public TokenSearchResponse getPaymentTokensSearch(Long space, Set<String> expand, Integer limit, Integer offset, String order, String query, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getPaymentTokensSearch");
    }
    
    // create path and map variables
    String localVarPath = "/payment/tokens/search";
    ...
    TypeReference<TokenSearchResponse> localVarReturnType = new TypeReference<TokenSearchResponse>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
   ...
   * @param id  (required)
   * @param space Specifies the ID of the space the operation should be executed in. (required)
   * @param tokenUpdate  (required)
   * @param expand  (optional)
   * @return Token
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#patchPaymentTokensId">Update a token Documentation</a>
   */
  ...
  public Token patchPaymentTokensId(Long id, Long space, TokenUpdate tokenUpdate, Set<String> expand, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling patchPaymentTokensId");
    }
    
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling patchPaymentTokensId");
    }
    
    // verify the required parameter 'tokenUpdate' is set
    if (tokenUpdate == null) {
      throw new ApiException(400, "Missing the required parameter 'tokenUpdate' when calling patchPaymentTokensId");
    }
   ...
   * @param space Specifies the ID of the space the operation should be executed in. (required)
   * @param tokenCreate  (required)
   * @param expand  (optional)
   * @return Token
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#postPaymentTokens">Create a token Documentation</a>
   */
  ...
  public Token postPaymentTokens(Long space, TokenCreate tokenCreate, Set<String> expand, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling postPaymentTokens");
    }
    
    // verify the required parameter 'tokenCreate' is set
    if (tokenCreate == null) {
      throw new ApiException(400, "Missing the required parameter 'tokenCreate' when calling postPaymentTokens");
    }
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#postPaymentTokensIdCreateTransactionForTokenUpdate">Create a transaction for token update Documentation</a>
   */
  ...
  public Transaction postPaymentTokensIdCreateTransactionForTokenUpdate(Long id, Long space, Set<String> expand, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling postPaymentTokensIdCreateTransactionForTokenUpdate");
    }
    
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling postPaymentTokensIdCreateTransactionForTokenUpdate");
    }
