...
public class LegalOrganizationFormService {
  ...
  /**
    ...
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#legal-organization-form-service--all">All Documentation</a>
  ...
  /**
    ...
    **/
    ...
    public HttpResponse allForHttpResponse() throws IOException {
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/legal-organization-form/all");
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#legal-organization-form-service--country">Find by Country Documentation</a>
  ...
  /**
    ...
    **/
    ...
    public HttpResponse countryForHttpResponse(String code) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/legal-organization-form/country");
        if (code != null) {
            String key = "code";
            Object value = code;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#legal-organization-form-service--read">Read Documentation</a>
  ...
  /**
    ...
    **/
    ...
    public HttpResponse readForHttpResponse(Long id) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/legal-organization-form/read");
        if (id != null) {
            String key = "id";
            Object value = id;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
