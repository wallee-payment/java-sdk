...
import com.wallee.sdk.model.SubscriptionLedgerEntryListResponse;
import com.wallee.sdk.model.SubscriptionLedgerEntrySearchResponse;
...
public class SubscriptionLedgerEntriesService extends BaseApi {

  public SubscriptionLedgerEntriesService(ApiClient apiClient) {
    super(apiClient);
  }
   ...
   * @return SubscriptionLedgerEntryListResponse
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getSubscriptionsLedgerEntries">List all ledger entries Documentation</a>
   */
  ...
  public SubscriptionLedgerEntryListResponse getSubscriptionsLedgerEntries(Long space, Long after, Long before, Set<String> expand, Integer limit, SortingOrder order, Map<String, String> additionalHeaders) throws ApiException {
    ...
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getSubscriptionsLedgerEntries");
    }
    
    // create path and map variables
    String localVarPath = "/subscriptions/ledger-entries";
    ...
    TypeReference<SubscriptionLedgerEntryListResponse> localVarReturnType = new TypeReference<SubscriptionLedgerEntryListResponse>() {};
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getSubscriptionsLedgerEntriesId">Retrieve a ledger entry Documentation</a>
   */
  ...
  public SubscriptionLedgerEntry getSubscriptionsLedgerEntriesId(Long id, Long space, Set<String> expand, Map<String, String> additionalHeaders) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getSubscriptionsLedgerEntriesId");
    }
    
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getSubscriptionsLedgerEntriesId");
    }
    ...
    TypeReference<SubscriptionLedgerEntry> localVarReturnType = new TypeReference<SubscriptionLedgerEntry>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
   ...
   * @return SubscriptionLedgerEntrySearchResponse
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getSubscriptionsLedgerEntriesSearch">Search ledger entries Documentation</a>
   */
  ...
  public SubscriptionLedgerEntrySearchResponse getSubscriptionsLedgerEntriesSearch(Long space, Set<String> expand, Integer limit, Integer offset, String order, String query, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getSubscriptionsLedgerEntriesSearch");
    }
    
    // create path and map variables
    String localVarPath = "/subscriptions/ledger-entries/search";
    ...
    TypeReference<SubscriptionLedgerEntrySearchResponse> localVarReturnType = new TypeReference<SubscriptionLedgerEntrySearchResponse>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
   ...
   * @param space Specifies the ID of the space the operation should be executed in. (required)
   * @param subscriptionLedgerEntryCreate  (required)
   * @param expand  (optional)
   * @return SubscriptionLedgerEntry
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#postSubscriptionsLedgerEntries">Create a ledger entry Documentation</a>
   */
  ...
  public SubscriptionLedgerEntry postSubscriptionsLedgerEntries(Long space, SubscriptionLedgerEntryCreate subscriptionLedgerEntryCreate, Set<String> expand, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling postSubscriptionsLedgerEntries");
    }
    
    // verify the required parameter 'subscriptionLedgerEntryCreate' is set
    if (subscriptionLedgerEntryCreate == null) {
      throw new ApiException(400, "Missing the required parameter 'subscriptionLedgerEntryCreate' when calling postSubscriptionsLedgerEntries");
    }
