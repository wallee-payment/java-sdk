...
import com.wallee.sdk.model.InvoiceReconciliationRecordInvoiceLink;
...
public class InvoiceReconciliationRecordInvoiceLinkService {
  ...
  /**
    ...
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#invoice-reconciliation-record-invoice-link-service--count">Count Documentation</a>
    ...
    public HttpResponse countForHttpResponse(Long spaceId, EntityQueryFilter filter) throws IOException {
        ...
        if (spaceId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'spaceId' when calling count");
                ...
                URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/invoice-reconciliation-record-invoice-link-service/count");
        if (spaceId != null) {
            String key = "spaceId";
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#invoice-reconciliation-record-invoice-link-service--link">Link Invoice Documentation</a>
    ...
    public HttpResponse linkForHttpResponse(Long spaceId, Long recordId, Long completionId, BigDecimal amount) throws IOException {
        ...
        if (completionId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'completionId' when calling link");
                ...
                URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/invoice-reconciliation-record-invoice-link-service/link");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#invoice-reconciliation-record-invoice-link-service--read">Read Documentation</a>
  ...
  /**
    ...
    **/
    ...
    public HttpResponse readForHttpResponse(Long spaceId, Long id) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/invoice-reconciliation-record-invoice-link-service/read");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#invoice-reconciliation-record-invoice-link-service--search">Search Documentation</a>
  ...
  /**
    ...
    **/
    ...
    public HttpResponse searchForHttpResponse(Long spaceId, EntityQuery query) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/invoice-reconciliation-record-invoice-link-service/search");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#invoice-reconciliation-record-invoice-link-service--unlink-transaction">Unlink Invoice Documentation</a>
  ...
  /**
    ...
    **/
    ...
    public HttpResponse unlinkTransactionForHttpResponse(Long spaceId, Long recordId, Long completionId) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/invoice-reconciliation-record-invoice-link-service/unlink-transaction");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
