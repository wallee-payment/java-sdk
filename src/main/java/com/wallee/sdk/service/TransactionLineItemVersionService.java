...
public class TransactionLineItemVersionService {
    private ApiClient apiClient;

    public TransactionLineItemVersionService(ApiClient apiClient) {
  ...
  /**
    ...
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#transaction-line-item-version-service--count">Count Documentation</a>
    ...
    public HttpResponse countForHttpResponse(Long spaceId, EntityQueryFilter filter) throws IOException {
        ...
        if (spaceId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'spaceId' when calling count");
                ...
                URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/transaction-line-item-version/count");
        if (spaceId != null) {
            String key = "spaceId";
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#transaction-line-item-version-service--create">create Documentation</a>
    ...
    **/
    public TransactionLineItemVersion create(Long spaceId, TransactionLineItemVersionCreate lineItemVersion) throws IOException {
        HttpResponse response = createForHttpResponse(spaceId, lineItemVersion);
  ...
  /**
    ...
    **/
    public TransactionLineItemVersion create(Long spaceId, TransactionLineItemVersionCreate lineItemVersion, Map<String, Object> params) throws IOException {
        HttpResponse response = createForHttpResponse(spaceId, lineItemVersion, params);
        String returnType = "TransactionLineItemVersion";
        if(returnType.equals("String")){
            return (TransactionLineItemVersion) (Object) response.parseAsString();
        }
    ...
    public HttpResponse createForHttpResponse(Long spaceId, TransactionLineItemVersionCreate lineItemVersion) throws IOException {
        // verify the required parameter 'spaceId' is set
        if (spaceId == null) {
        ...
        if (lineItemVersion == null) {
            throw new IllegalArgumentException("Missing the required parameter 'lineItemVersion' when calling create");
        }
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/transaction-line-item-version/create");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
        ...
        HttpContent content = apiClient.new JacksonJsonHttpContent(lineItemVersion);
        HttpRequest httpRequest = apiClient.getHttpRequestFactory().buildRequest(HttpMethods.POST, genericUrl, content);
    ...
    public HttpResponse createForHttpResponse(Long spaceId, java.io.InputStream lineItemVersion, String mediaType) throws IOException {
        // verify the required parameter 'spaceId' is set
        if (spaceId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'spaceId' when calling create");
        }
        ...
        HttpContent content = lineItemVersion == null ?
            apiClient.new JacksonJsonHttpContent(null) :
    ...
    public HttpResponse createForHttpResponse(Long spaceId, TransactionLineItemVersionCreate lineItemVersion, Map<String, Object> params) throws IOException {
        // verify the required parameter 'spaceId' is set
        if (spaceId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'spaceId' when calling create");
        }
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#transaction-line-item-version-service--read">Read Documentation</a>
  ...
  /**
    ...
    **/
    ...
    public HttpResponse readForHttpResponse(Long spaceId, Long id) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/transaction-line-item-version/read");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#transaction-line-item-version-service--search">Search Documentation</a>

    **/
    public List<TransactionLineItemVersion> search(Long spaceId, EntityQuery query) throws IOException {
        HttpResponse response = searchForHttpResponse(spaceId, query);
        String returnType = "List&lt;TransactionLineItemVersion&gt;";
        if(returnType.equals("String")){
  ...
  /**
    ...
    **/
    ...
    public HttpResponse searchForHttpResponse(Long spaceId, EntityQuery query) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/transaction-line-item-version/search");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
