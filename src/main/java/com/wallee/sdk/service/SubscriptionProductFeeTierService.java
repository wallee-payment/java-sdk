...
public class SubscriptionProductFeeTierService {
    ...
    public HttpResponse countForHttpResponse(Long spaceId, EntityQueryFilter filter) throws IOException {
        return ServiceUtils.countForHttpResponse(spaceId, filter, false, apiClient, "/subscription-product-fee-tier/count");
    }

    public HttpResponse countForHttpResponse(Long spaceId, InputStream filter, String mediaType) throws IOException {
        return ServiceUtils.countForHttpResponse(spaceId, filter, mediaType, false, apiClient, "/subscription-product-fee-tier/count");
    }

    public HttpResponse countForHttpResponse(EntityQueryFilter filter, Long spaceId, Map<String, Object> params) throws IOException {
        return ServiceUtils.countForHttpResponse(filter, spaceId, params, apiClient, "/subscription-product-fee-tier/count");
    }
    ...
    public HttpResponse createForHttpResponse(Long spaceId, ProductMeteredTierFeeUpdate entity) throws IOException {
        return ServiceUtils.createForHttpResponse(spaceId, entity, apiClient, "/subscription-product-fee-tier/create");
    }

    public HttpResponse createForHttpResponse(Long spaceId, InputStream entity, String mediaType) throws IOException {
        return ServiceUtils.createForHttpResponse(spaceId, entity, mediaType, apiClient, "/subscription-product-fee-tier/create");
    }

    public HttpResponse createForHttpResponse(Long spaceId, ProductMeteredTierFeeUpdate entity, Map<String, Object> params) throws IOException {
        return ServiceUtils.createForHttpResponse(spaceId, entity, params, apiClient, "/subscription-product-fee-tier/create");
    }
    ...
    public HttpResponse deleteForHttpResponse(Long spaceId, Long id) throws IOException {
        return ServiceUtils.deleteForHttpResponse(spaceId, id, apiClient, "/subscription-product-fee-tier/delete");
    }

    public HttpResponse deleteForHttpResponse(Long spaceId, InputStream id, String mediaType) throws IOException {
        return ServiceUtils.deleteForHttpResponse(spaceId, id, mediaType, apiClient, "/subscription-product-fee-tier/delete");
    }

    public HttpResponse deleteForHttpResponse(Long spaceId, Long id, Map<String, Object> params) throws IOException {
        return ServiceUtils.deleteForHttpResponse(spaceId, id, params, apiClient, "/subscription-product-fee-tier/delete");
    }
    ...
    public HttpResponse readForHttpResponse(Long spaceId, Long id) throws IOException {
        return ServiceUtils.readForHttpResponse(spaceId, id, apiClient, "/subscription-product-fee-tier/read");
    }

    public HttpResponse readForHttpResponse(Long spaceId, Long id, Map<String, Object> params) throws IOException {
        return ServiceUtils.readForHttpResponse(spaceId, id, params, apiClient, "/subscription-product-fee-tier/read");
    }
    ...
    public HttpResponse searchForHttpResponse(Long spaceId, EntityQuery query) throws IOException {
        ...
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/subscription-product-fee-tier/search");
        String key = "spaceId";
    ...
    public HttpResponse updateForHttpResponse(Long spaceId, ProductMeteredTierFeeUpdate entity) throws IOException {
        ...
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/subscription-product-fee-tier/update");
        String key = "spaceId";
        uriBuilder = uriBuilder.queryParam(key, spaceId);
    ...
    public HttpResponse updateForHttpResponse(Long spaceId, ProductMeteredTierFeeUpdate entity, Map<String, Object> params) throws IOException {
        // verify the required parameter 'spaceId' is set
        if (spaceId == null) {
            throw new IllegalArgumentException(String.format(ServiceUtils.MISSING_PARAM_1_WHEN_CALLING_2, "spaceId", "update"));
        }// verify the required parameter 'entity' is set
