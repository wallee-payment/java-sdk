...
public class SubscriptionLedgerEntryService {
    ...
    public com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/subscription-ledger-entry/count";
     ...
     */
    public com.squareup.okhttp.Call createCall(Long spaceId, SubscriptionLedgerEntryCreate entry, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = entry;

        // create path and map variables
        String localVarPath = "/subscription-ledger-entry/create";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createValidateBeforeCall(Long spaceId, SubscriptionLedgerEntryCreate entry, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (entry == null) {
            throw new ApiException("Missing the required parameter 'entry' when calling create(Async)");
        }
        

        com.squareup.okhttp.Call call = createCall(spaceId, entry, progressListener, progressRequestListener);
        return call;
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-ledger-entry-service--create">Create Documentation</a>
     */
    public SubscriptionLedgerEntry create(Long spaceId, SubscriptionLedgerEntryCreate entry) throws ApiException {
        ApiResponse<SubscriptionLedgerEntry> resp = createWithHttpInfo(spaceId, entry);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param entry  (required)
     * @return ApiResponse&lt;SubscriptionLedgerEntry&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-ledger-entry-service--create">Create Documentation</a>
     */
    public ApiResponse<SubscriptionLedgerEntry> createWithHttpInfo(Long spaceId, SubscriptionLedgerEntryCreate entry) throws ApiException {
        com.squareup.okhttp.Call call = createValidateBeforeCall(spaceId, entry, null, null);
        Type localVarReturnType = new TypeToken<SubscriptionLedgerEntry>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-ledger-entry-service--create">Create Documentation</a>
     */
    public com.squareup.okhttp.Call createAsync(Long spaceId, SubscriptionLedgerEntryCreate entry, final ApiCallback<SubscriptionLedgerEntry> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createValidateBeforeCall(spaceId, entry, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<SubscriptionLedgerEntry>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscription-ledger-entry/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-ledger-entry-service--read">Read Documentation</a>
     */
    public SubscriptionLedgerEntry read(Long spaceId, Long id) throws ApiException {
        ApiResponse<SubscriptionLedgerEntry> resp = readWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-ledger-entry-service--read">Read Documentation</a>
     */
    public ApiResponse<SubscriptionLedgerEntry> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-ledger-entry-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<SubscriptionLedgerEntry> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscription-ledger-entry/search";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-ledger-entry-service--search">Search Documentation</a>
     */
    public List<SubscriptionLedgerEntry> search(Long spaceId, EntityQuery query) throws ApiException {
        ApiResponse<List<SubscriptionLedgerEntry>> resp = searchWithHttpInfo(spaceId, query);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param query The query restricts the subscription charges which are returned by the search. (required)
     * @return ApiResponse&lt;List&lt;SubscriptionLedgerEntry&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-ledger-entry-service--search">Search Documentation</a>
     */
    public ApiResponse<List<SubscriptionLedgerEntry>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
        com.squareup.okhttp.Call call = searchValidateBeforeCall(spaceId, query, null, null);
        Type localVarReturnType = new TypeToken<List<SubscriptionLedgerEntry>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-ledger-entry-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<SubscriptionLedgerEntry>> callback) throws ApiException {
