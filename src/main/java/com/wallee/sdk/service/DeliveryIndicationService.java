...
public class DeliveryIndicationService {
    ...
    public com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/delivery-indication/count";
     ...
     */
    public com.squareup.okhttp.Call markAsNotSuitableCall(Long spaceId, Long deliveryIndicationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = deliveryIndicationId;

        // create path and map variables
        String localVarPath = "/delivery-indication/markAsNotSuitable";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call markAsNotSuitableValidateBeforeCall(Long spaceId, Long deliveryIndicationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<DeliveryIndication> markAsNotSuitableWithHttpInfo(Long spaceId, Long deliveryIndicationId) throws ApiException {
        com.squareup.okhttp.Call call = markAsNotSuitableValidateBeforeCall(spaceId, deliveryIndicationId, null, null);
    ...
    public com.squareup.okhttp.Call markAsNotSuitableAsync(Long spaceId, Long deliveryIndicationId, final ApiCallback<DeliveryIndication> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = markAsNotSuitableValidateBeforeCall(spaceId, deliveryIndicationId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeliveryIndication>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     */
    public com.squareup.okhttp.Call markAsSuitableCall(Long spaceId, Long deliveryIndicationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = deliveryIndicationId;

        // create path and map variables
        String localVarPath = "/delivery-indication/markAsSuitable";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call markAsSuitableValidateBeforeCall(Long spaceId, Long deliveryIndicationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<DeliveryIndication> markAsSuitableWithHttpInfo(Long spaceId, Long deliveryIndicationId) throws ApiException {
        com.squareup.okhttp.Call call = markAsSuitableValidateBeforeCall(spaceId, deliveryIndicationId, null, null);
        Type localVarReturnType = new TypeToken<DeliveryIndication>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call markAsSuitableAsync(Long spaceId, Long deliveryIndicationId, final ApiCallback<DeliveryIndication> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = markAsSuitableValidateBeforeCall(spaceId, deliveryIndicationId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeliveryIndication>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/delivery-indication/read";
    ...
    public com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/delivery-indication/search";
