...
public class DebtCollectorService {
  ...
  /**
    ...
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#debt-collector-service--all">All Documentation</a>

    **/
    public List<DebtCollector> all() throws IOException {
        HttpResponse response = allForHttpResponse();
        String returnType = "List&lt;DebtCollector&gt;";
        if(returnType.equals("String")){
          return (List<DebtCollector>) (Object) response.parseAsString();
        }
  ...
  /**
    ...
    **/
    ...
    public HttpResponse allForHttpResponse() throws IOException {
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/debt-collector/all");
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#debt-collector-service--read">Read Documentation</a>

    **/
    public DebtCollector read(Long id) throws IOException {
        HttpResponse response = readForHttpResponse(id);
        String returnType = "DebtCollector";
        if(returnType.equals("String")){
          return (DebtCollector) (Object) response.parseAsString();
        }
  ...
  /**
    ...
    **/
    ...
    public HttpResponse readForHttpResponse(Long id) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/debt-collector/read");
        if (id != null) {
            String key = "id";
            Object value = id;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
