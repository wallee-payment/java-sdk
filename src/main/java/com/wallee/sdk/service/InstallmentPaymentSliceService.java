...
public class InstallmentPaymentSliceService {
    ...
    public HttpResponse countForHttpResponse(Long spaceId, EntityQueryFilter filter) throws IOException {
        return ServiceUtils.countForHttpResponse(spaceId, filter, true, apiClient, "/installment-payment-slice/count");
    }

    public HttpResponse countForHttpResponse(Long spaceId, InputStream filter, String mediaType) throws IOException {
        return ServiceUtils.countForHttpResponse(spaceId, filter, mediaType, true, apiClient, "/installment-payment-slice/count");
    }
    ...
    public InstallmentPaymentSlice read(Long spaceId, Long id) throws IOException {
        ...
        return apiClient.getObjectMapper().readValue(response.getContent(), new TypeReference<InstallmentPaymentSlice>() {
        });
    }
    ...
    public HttpResponse readForHttpResponse(Long spaceId, Long id) throws IOException {
        return ServiceUtils.readForHttpResponse(spaceId, id, apiClient, "/installment-payment-slice/read");
    }

    public HttpResponse readForHttpResponse(Long spaceId, Long id, Map<String, Object> params) throws IOException {
        return ServiceUtils.readForHttpResponse(spaceId, id, params, apiClient, "/installment-payment-slice/read");
    }
    ...
    public List<InstallmentPaymentSlice> search(Long spaceId, EntityQuery query) throws IOException {
        ...
        return apiClient.getObjectMapper().readValue(response.getContent(), new TypeReference<List<InstallmentPaymentSlice>>() {
        });
    }
