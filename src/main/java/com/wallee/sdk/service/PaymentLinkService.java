...
public class PaymentLinkService {
    ...
    public HttpResponse countForHttpResponse(Long spaceId, EntityQueryFilter filter) throws IOException {
        return ServiceUtils.countForHttpResponse(spaceId, filter, false, apiClient, "/payment-link/count");
    }

    public HttpResponse countForHttpResponse(Long spaceId, InputStream filter, String mediaType) throws IOException {
        return ServiceUtils.countForHttpResponse(spaceId, filter, mediaType, false, apiClient, "/payment-link/count");
    }

    public HttpResponse countForHttpResponse(EntityQueryFilter filter, Long spaceId, Map<String, Object> params) throws IOException {
        return ServiceUtils.countForHttpResponse(filter, spaceId, params, apiClient, "/payment-link/count");
    }
    ...
    public PaymentLink create(Long spaceId, PaymentLinkCreate entity) throws IOException {
        ...
        return apiClient.getObjectMapper().readValue(response.getContent(), new TypeReference<PaymentLink>() {
        });
    }
    ...
    public HttpResponse createForHttpResponse(Long spaceId, PaymentLinkCreate entity) throws IOException {
        return ServiceUtils.createForHttpResponse(spaceId, entity, apiClient, "/payment-link/create");
    }

    public HttpResponse createForHttpResponse(Long spaceId, InputStream entity, String mediaType) throws IOException {
        return ServiceUtils.createForHttpResponse(spaceId, entity, mediaType, apiClient, "/payment-link/create");
    }
    ...
    public HttpResponse createForHttpResponse(Long spaceId, PaymentLinkCreate entity, Map<String, Object> params) throws IOException {
        return ServiceUtils.createForHttpResponse(spaceId, entity, params, apiClient, "/payment-link/create");
    }
    ...
    public HttpResponse deleteForHttpResponse(Long spaceId, Long id) throws IOException {
        return ServiceUtils.deleteForHttpResponse(spaceId, id, apiClient, "/payment-link/delete");
    }

    public HttpResponse deleteForHttpResponse(Long spaceId, InputStream id, String mediaType) throws IOException {
        return ServiceUtils.deleteForHttpResponse(spaceId, id, mediaType, apiClient, "/payment-link/delete");
    }

    public HttpResponse deleteForHttpResponse(Long spaceId, Long id, Map<String, Object> params) throws IOException {
        return ServiceUtils.deleteForHttpResponse(spaceId, id, params, apiClient, "/payment-link/delete");
    }
    ...
    public HttpResponse readForHttpResponse(Long spaceId, Long id) throws IOException {
        return ServiceUtils.readForHttpResponse(spaceId, id, apiClient, "/payment-link/read");
    }

    public HttpResponse readForHttpResponse(Long spaceId, Long id, Map<String, Object> params) throws IOException {
        return ServiceUtils.readForHttpResponse(spaceId, id, params, apiClient, "/payment-link/read");
    }
    ...
    public List<PaymentLink> search(Long spaceId, EntityQuery query) throws IOException {
        ...
        return apiClient.getObjectMapper().readValue(response.getContent(), new TypeReference<List<PaymentLink>>() {
        });
    }
    ...
    public HttpResponse searchForHttpResponse(Long spaceId, EntityQuery query) throws IOException {
        ...
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/payment-link/search");
        String key = "spaceId";
    ...
    public HttpResponse updateForHttpResponse(Long spaceId, PaymentLinkUpdate entity) throws IOException {
        ...
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/payment-link/update");
        String key = "spaceId";
        uriBuilder = uriBuilder.queryParam(key, spaceId);
