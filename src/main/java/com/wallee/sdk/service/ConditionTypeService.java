...
public class ConditionTypeService {
  ...
  /**
    ...
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#condition-type-service--all">All Documentation</a>

    **/
    public List<ConditionType> all() throws IOException {
        HttpResponse response = allForHttpResponse();
        String returnType = "List&lt;ConditionType&gt;";
        if(returnType.equals("String")){
          return (List<ConditionType>) (Object) response.parseAsString();
        }
  ...
  /**
    ...
    **/
    ...
    public HttpResponse allForHttpResponse() throws IOException {
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/condition-type/all");
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#condition-type-service--read">Read Documentation</a>

    **/
    public ConditionType read(Long id) throws IOException {
        HttpResponse response = readForHttpResponse(id);
        String returnType = "ConditionType";
        if(returnType.equals("String")){
          return (ConditionType) (Object) response.parseAsString();
        }
  ...
  /**
    ...
    **/
    ...
    public HttpResponse readForHttpResponse(Long id) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/condition-type/read");
        if (id != null) {
            String key = "id";
            Object value = id;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
