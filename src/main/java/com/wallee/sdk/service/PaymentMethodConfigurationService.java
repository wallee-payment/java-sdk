...
public class PaymentMethodConfigurationService {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-configuration-service--count">Count Documentation</a>
     */
    public com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/payment-method-configuration/count";
     ...
     * Build call for read
     * @param spaceId  (required)
     * @param id The id of the payment method configuration which should be returned. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-configuration-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/payment-method-configuration/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-configuration-service--read">Read Documentation</a>
     */
    public PaymentMethodConfiguration read(Long spaceId, Long id) throws ApiException {
        ApiResponse<PaymentMethodConfiguration> resp = readWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param id The id of the payment method configuration which should be returned. (required)
     * @return ApiResponse&lt;PaymentMethodConfiguration&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-configuration-service--read">Read Documentation</a>
     */
    public ApiResponse<PaymentMethodConfiguration> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
        com.squareup.okhttp.Call call = readValidateBeforeCall(spaceId, id, null, null);
        Type localVarReturnType = new TypeToken<PaymentMethodConfiguration>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-configuration-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<PaymentMethodConfiguration> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param query The query restricts the payment method configuration which are returned by the search. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-configuration-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/payment-method-configuration/search";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-configuration-service--search">Search Documentation</a>
     */
    public List<PaymentMethodConfiguration> search(Long spaceId, EntityQuery query) throws ApiException {
        ApiResponse<List<PaymentMethodConfiguration>> resp = searchWithHttpInfo(spaceId, query);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-configuration-service--search">Search Documentation</a>
     */
    public ApiResponse<List<PaymentMethodConfiguration>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-configuration-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<PaymentMethodConfiguration>> callback) throws ApiException {
