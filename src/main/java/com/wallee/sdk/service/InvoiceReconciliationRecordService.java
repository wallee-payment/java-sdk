...
public class InvoiceReconciliationRecordService {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service#invoice-reconciliation-record-service--link-transaction">Link transaction Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service#invoice-reconciliation-record-service--unlink-transaction">Unlink transaction Documentation</a>
