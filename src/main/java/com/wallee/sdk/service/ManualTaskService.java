...
public class ManualTaskService {
    ...
    public ManualTaskService(ApiClient apiClient) {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#manual-task-service--count">Count Documentation</a>
     */
    public com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/manual-task/count";
     ...
     * Build call for read
     * @param spaceId  (required)
     * @param id The id of the manual task which should be returned. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#manual-task-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/manual-task/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#manual-task-service--read">Read Documentation</a>
     */
    public ManualTask read(Long spaceId, Long id) throws ApiException {
        ApiResponse<ManualTask> resp = readWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param id The id of the manual task which should be returned. (required)
     * @return ApiResponse&lt;ManualTask&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#manual-task-service--read">Read Documentation</a>
     */
    public ApiResponse<ManualTask> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
        com.squareup.okhttp.Call call = readValidateBeforeCall(spaceId, id, null, null);
        Type localVarReturnType = new TypeToken<ManualTask>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#manual-task-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<ManualTask> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param query The query restricts the manual tasks which are returned by the search. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#manual-task-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/manual-task/search";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#manual-task-service--search">Search Documentation</a>
     */
    public List<ManualTask> search(Long spaceId, EntityQuery query) throws ApiException {
        ApiResponse<List<ManualTask>> resp = searchWithHttpInfo(spaceId, query);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param query The query restricts the manual tasks which are returned by the search. (required)
     * @return ApiResponse&lt;List&lt;ManualTask&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#manual-task-service--search">Search Documentation</a>
     */
    public ApiResponse<List<ManualTask>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
        com.squareup.okhttp.Call call = searchValidateBeforeCall(spaceId, query, null, null);
        Type localVarReturnType = new TypeToken<List<ManualTask>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#manual-task-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<ManualTask>> callback) throws ApiException {
