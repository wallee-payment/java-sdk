  ...
  /**
    ...
    **/
    ...
    public HttpResponse countForHttpResponse(Long spaceId, EntityQueryFilter filter) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/installment-plan-configuration/count");
        if (spaceId != null) {
            String key = "spaceId";
  ...
  /**
    ...
    **/
    public InstallmentPlanConfiguration read(Long spaceId, Long id) throws IOException {
        ...
        String returnType = "InstallmentPlanConfiguration";
        if(returnType.equals("String")){
          return (InstallmentPlanConfiguration) (Object) response.parseAsString();
        }
  ...
  /**
    ...
    **/
    ...
    public HttpResponse readForHttpResponse(Long spaceId, Long id) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/installment-plan-configuration/read");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    **/
    public List<InstallmentPlanConfiguration> search(Long spaceId, EntityQuery query) throws IOException {
        ...
        String returnType = "List&lt;InstallmentPlanConfiguration&gt;";
        if(returnType.equals("String")){
          return (List<InstallmentPlanConfiguration>) (Object) response.parseAsString();
        }
  ...
  /**
    ...
    **/
    ...
    public HttpResponse searchForHttpResponse(Long spaceId, EntityQuery query) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/installment-plan-configuration/search");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
