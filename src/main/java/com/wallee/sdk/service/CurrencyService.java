...
public class CurrencyService {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#currency-service--all">All Documentation</a>
     */
    public com.squareup.okhttp.Call allCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/currency/all";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#currency-service--all">All Documentation</a>
     */
    public List<RestCurrency> all() throws ApiException {
        ApiResponse<List<RestCurrency>> resp = allWithHttpInfo();
        return resp.getData();
    }
     ...
     * All
     * This operation returns all currencies.
     * @return ApiResponse&lt;List&lt;RestCurrency&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#currency-service--all">All Documentation</a>
     */
    public ApiResponse<List<RestCurrency>> allWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = allValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<List<RestCurrency>>(){}.getType();
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#currency-service--all">All Documentation</a>
     */
    public com.squareup.okhttp.Call allAsync(final ApiCallback<List<RestCurrency>> callback) throws ApiException {
