...
public class TransactionCompletionService {
	...
	private com.squareup.okhttp.Call completeOfflineCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		String localVarPath = "/transaction-completion/completeOffline".replaceAll("\\{format\\}","json");
	...
	public ApiResponse<TransactionCompletion> completeOfflineWithHttpInfo(Long spaceId, Long id) throws ApiException {
		com.squareup.okhttp.Call call = completeOfflineCall(spaceId, id, null, null);
	...
	private com.squareup.okhttp.Call completeOnlineCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody = null;
		...
		// create path and map variables
		String localVarPath = "/transaction-completion/completeOnline".replaceAll("\\{format\\}","json");
	...
	public ApiResponse<TransactionCompletion> completeOnlineWithHttpInfo(Long spaceId, Long id) throws ApiException {
		com.squareup.okhttp.Call call = completeOnlineCall(spaceId, id, null, null);
		Type localVarReturnType = new TypeToken<TransactionCompletion>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	...
	private com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/transaction-completion/count".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/transaction-completion/read".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/transaction-completion/search".replaceAll("\\{format\\}","json");
