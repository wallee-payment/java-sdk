...
import com.wallee.sdk.model.ChargeAttemptListResponse;
import com.wallee.sdk.model.ChargeAttemptSearchResponse;
...
public class ChargeAttemptsService extends BaseApi {

  public ChargeAttemptsService(ApiClient apiClient) {
    super(apiClient);
  }
   ...
   * @return ChargeAttemptListResponse
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentChargeAttempts">List all charge attempts Documentation</a>
   */
  ...
  public ChargeAttemptListResponse getPaymentChargeAttempts(@javax.annotation.Nonnull Long space, @javax.annotation.Nullable Long after, @javax.annotation.Nullable Long before, @javax.annotation.Nullable Set<String> expand, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable SortingOrder order, Map<String, String> additionalHeaders) throws ApiException {
    ...
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getPaymentChargeAttempts");
    }
    
    // create path and map variables
    String localVarPath = "/payment/charge-attempts";
    ...
    TypeReference<ChargeAttemptListResponse> localVarReturnType = new TypeReference<ChargeAttemptListResponse>() {};
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentChargeAttemptsId">Retrieve a charge attempt Documentation</a>
   */
  ...
  public ChargeAttempt getPaymentChargeAttemptsId(@javax.annotation.Nonnull Long id, @javax.annotation.Nonnull Long space, @javax.annotation.Nullable Set<String> expand, Map<String, String> additionalHeaders) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getPaymentChargeAttemptsId");
    }
    
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getPaymentChargeAttemptsId");
    }
   ...
   * @return ChargeAttemptSearchResponse
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentChargeAttemptsSearch">Search charge attempts Documentation</a>
   */
  ...
  public ChargeAttemptSearchResponse getPaymentChargeAttemptsSearch(@javax.annotation.Nonnull Long space, @javax.annotation.Nullable Set<String> expand, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String order, @javax.annotation.Nullable String query, Map<String, String> additionalHeaders) throws ApiException {
    ...
    // verify the required parameter 'space' is set
    if (space == null) {
      throw new ApiException(400, "Missing the required parameter 'space' when calling getPaymentChargeAttemptsSearch");
    }
    
    // create path and map variables
    String localVarPath = "/payment/charge-attempts/search";
    ...
    TypeReference<ChargeAttemptSearchResponse> localVarReturnType = new TypeReference<ChargeAttemptSearchResponse>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
