...
public class CustomerAddressService {
  ...
  /**
    ...
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#customer-address-service--count">Count Documentation</a>
    ...
    public HttpResponse countForHttpResponse(Long spaceId, EntityQueryFilter filter) throws IOException {
        ...
        if (spaceId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'spaceId' when calling count");
                ...
                URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/customer-address/count");
        if (spaceId != null) {
            String key = "spaceId";
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#customer-address-service--create">Create Documentation</a>
    ...
    **/
    public CustomerAddress create(Long spaceId, CustomerAddressCreate entity) throws IOException {
        ...
        String returnType = "CustomerAddress";
        if(returnType.equals("String")){
          return (CustomerAddress) (Object) response.parseAsString();
        }
  ...
  /**
    ...
    **/
    ...
    public HttpResponse createForHttpResponse(Long spaceId, CustomerAddressCreate entity) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/customer-address/create");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
    ...
    public HttpResponse createForHttpResponse(Long spaceId, CustomerAddressCreate entity, Map<String, Object> params) throws IOException {
        // verify the required parameter 'spaceId' is set
        if (spaceId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'spaceId' when calling create");
        }
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#customer-address-service--delete">Delete Documentation</a>
  ...
  /**
    ...
    **/
    ...
    public HttpResponse deleteForHttpResponse(Long spaceId, Long id) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/customer-address/delete");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#customer-address-service--read">Read Documentation</a>
  ...
  /**
    ...
    **/
    ...
    public HttpResponse readForHttpResponse(Long spaceId, Long id) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/customer-address/read");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#customer-address-service--search">Search Documentation</a>

    **/
    public List<CustomerAddress> search(Long spaceId, EntityQuery query) throws IOException {
        HttpResponse response = searchForHttpResponse(spaceId, query);
        String returnType = "List&lt;CustomerAddress&gt;";
        if(returnType.equals("String")){
          return (List<CustomerAddress>) (Object) response.parseAsString();
        }
  ...
  /**
    ...
    **/
    ...
    public HttpResponse searchForHttpResponse(Long spaceId, EntityQuery query) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/customer-address/search");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#customer-address-service--select-default-address">selectDefaultAddress Documentation</a>

    **/
    public void selectDefaultAddress(Long spaceId, Long id) throws IOException {
        selectDefaultAddressForHttpResponse(spaceId, id);
    }
  ...
  /**
    ...
    **/
    public void selectDefaultAddress(Long spaceId, Long id, Map<String, Object> params) throws IOException {
        selectDefaultAddressForHttpResponse(spaceId, id, params);
    }

    public HttpResponse selectDefaultAddressForHttpResponse(Long spaceId, Long id) throws IOException {
        // verify the required parameter 'spaceId' is set
        if (spaceId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'spaceId' when calling selectDefaultAddress");
        }
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new IllegalArgumentException("Missing the required parameter 'id' when calling selectDefaultAddress");
        }
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/customer-address/select-default-address");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#customer-address-service--update">Update Documentation</a>
  ...
  /**
    ...
    **/
    ...
    public HttpResponse updateForHttpResponse(Long spaceId, CustomerAddressActive entity) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/customer-address/update");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
