...
public class WebhookUrlService {
    ...
    public com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/webhook-url/count";
     ...
     * @param spaceId  (required)
     * @param entity The webhook url object with the properties which should be created. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public com.squareup.okhttp.Call createCall(Long spaceId, WebhookUrlCreate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = entity;

        // create path and map variables
        String localVarPath = "/webhook-url/create";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createValidateBeforeCall(Long spaceId, WebhookUrlCreate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#webhook-url-service--create">Create Documentation</a>
     */
    public WebhookUrl create(Long spaceId, WebhookUrlCreate entity) throws ApiException {
        ApiResponse<WebhookUrl> resp = createWithHttpInfo(spaceId, entity);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param entity The webhook url object with the properties which should be created. (required)
     * @return ApiResponse&lt;WebhookUrl&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#webhook-url-service--create">Create Documentation</a>
     */
    public ApiResponse<WebhookUrl> createWithHttpInfo(Long spaceId, WebhookUrlCreate entity) throws ApiException {
        com.squareup.okhttp.Call call = createValidateBeforeCall(spaceId, entity, null, null);
        Type localVarReturnType = new TypeToken<WebhookUrl>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#webhook-url-service--create">Create Documentation</a>
     */
    public com.squareup.okhttp.Call createAsync(Long spaceId, WebhookUrlCreate entity, final ApiCallback<WebhookUrl> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call deleteCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/webhook-url/delete";
     ...
     * Build call for read
     * @param spaceId  (required)
     * @param id The id of the webhook url which should be returned. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/webhook-url/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#webhook-url-service--read">Read Documentation</a>
     */
    public WebhookUrl read(Long spaceId, Long id) throws ApiException {
        ApiResponse<WebhookUrl> resp = readWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#webhook-url-service--read">Read Documentation</a>
     */
    public ApiResponse<WebhookUrl> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#webhook-url-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<WebhookUrl> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param query The query restricts the webhook urls which are returned by the search. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/webhook-url/search";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#webhook-url-service--search">Search Documentation</a>
     */
    public List<WebhookUrl> search(Long spaceId, EntityQuery query) throws ApiException {
        ApiResponse<List<WebhookUrl>> resp = searchWithHttpInfo(spaceId, query);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param query The query restricts the webhook urls which are returned by the search. (required)
     * @return ApiResponse&lt;List&lt;WebhookUrl&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#webhook-url-service--search">Search Documentation</a>
     */
    public ApiResponse<List<WebhookUrl>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
        com.squareup.okhttp.Call call = searchValidateBeforeCall(spaceId, query, null, null);
        Type localVarReturnType = new TypeToken<List<WebhookUrl>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#webhook-url-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<WebhookUrl>> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param entity The webhook url object with all the properties which should be updated. The id and the version are required properties. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public com.squareup.okhttp.Call updateCall(Long spaceId, WebhookUrlUpdate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = entity;

        // create path and map variables
        String localVarPath = "/webhook-url/update";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateValidateBeforeCall(Long spaceId, WebhookUrlUpdate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#webhook-url-service--update">Update Documentation</a>
     */
    public WebhookUrl update(Long spaceId, WebhookUrlUpdate entity) throws ApiException {
        ApiResponse<WebhookUrl> resp = updateWithHttpInfo(spaceId, entity);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#webhook-url-service--update">Update Documentation</a>
     */
    public ApiResponse<WebhookUrl> updateWithHttpInfo(Long spaceId, WebhookUrlUpdate entity) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#webhook-url-service--update">Update Documentation</a>
     */
    public com.squareup.okhttp.Call updateAsync(Long spaceId, WebhookUrlUpdate entity, final ApiCallback<WebhookUrl> callback) throws ApiException {
