...
import com.wallee.sdk.model.ExternalTransferBankTransactionListResponse;
import com.wallee.sdk.model.ExternalTransferBankTransactionSearchResponse;
...
public class ExternalTransferBankTransactionsService extends BaseApi {
   ...
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentBankTransactionsExternalTransfers">List all external transfer bank transactions Documentation</a>
   */
  public ExternalTransferBankTransactionListResponse getPaymentBankTransactionsExternalTransfers(Long space, Long after, Long before, Set<String> expand, Integer limit, SortingOrder order) throws ApiException {
   ...
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentBankTransactionsExternalTransfers">List all external transfer bank transactions Documentation</a>
   */
  public ExternalTransferBankTransactionListResponse getPaymentBankTransactionsExternalTransfers(Long space, Long after, Long before, Set<String> expand, Integer limit, SortingOrder order, Map<String, String> additionalHeaders) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentBankTransactionsExternalTransfersId">Retrieve an external transfer bank transaction Documentation</a>
   */
  public ExternalTransferBankTransaction getPaymentBankTransactionsExternalTransfersId(Long id, Long space, Set<String> expand) throws ApiException {
   ...
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentBankTransactionsExternalTransfersId">Retrieve an external transfer bank transaction Documentation</a>
   */
  public ExternalTransferBankTransaction getPaymentBankTransactionsExternalTransfersId(Long id, Long space, Set<String> expand, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentBankTransactionsExternalTransfersSearch">Search external transfer bank transactions Documentation</a>
   */
  public ExternalTransferBankTransactionSearchResponse getPaymentBankTransactionsExternalTransfersSearch(Long space, Set<String> expand, Integer limit, Integer offset, String order, String query) throws ApiException {
   ...
   * @see <a href="https://app-wallee.com/doc/api/web-service#getPaymentBankTransactionsExternalTransfersSearch">Search external transfer bank transactions Documentation</a>
   */
  public ExternalTransferBankTransactionSearchResponse getPaymentBankTransactionsExternalTransfersSearch(Long space, Set<String> expand, Integer limit, Integer offset, String order, String query, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
