...
public class ChargeFlowLevelService {
    ...
    public com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/charge-flow-level/count";
     ...
     * Build call for read
     * @param spaceId  (required)
     * @param id The id of the payment flow level which should be returned. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/charge-flow-level/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#charge-flow-level-service--read">Read Documentation</a>
     */
    public ChargeFlowLevel read(Long spaceId, Long id) throws ApiException {
        ApiResponse<ChargeFlowLevel> resp = readWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param id The id of the payment flow level which should be returned. (required)
     * @return ApiResponse&lt;ChargeFlowLevel&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#charge-flow-level-service--read">Read Documentation</a>
     */
    public ApiResponse<ChargeFlowLevel> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
        com.squareup.okhttp.Call call = readValidateBeforeCall(spaceId, id, null, null);
        Type localVarReturnType = new TypeToken<ChargeFlowLevel>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#charge-flow-level-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<ChargeFlowLevel> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param query The query restricts the payment flow levels which are returned by the search. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/charge-flow-level/search";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#charge-flow-level-service--search">Search Documentation</a>
     */
    public List<ChargeFlowLevel> search(Long spaceId, EntityQuery query) throws ApiException {
        ApiResponse<List<ChargeFlowLevel>> resp = searchWithHttpInfo(spaceId, query);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param query The query restricts the payment flow levels which are returned by the search. (required)
     * @return ApiResponse&lt;List&lt;ChargeFlowLevel&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#charge-flow-level-service--search">Search Documentation</a>
     */
    public ApiResponse<List<ChargeFlowLevel>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
        com.squareup.okhttp.Call call = searchValidateBeforeCall(spaceId, query, null, null);
        Type localVarReturnType = new TypeToken<List<ChargeFlowLevel>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#charge-flow-level-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<ChargeFlowLevel>> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param id The id of the charge flow level whose payment link should be sent. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public com.squareup.okhttp.Call sendMessageCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/charge-flow-level/sendMessage";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call sendMessageValidateBeforeCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'spaceId' is set
        if (spaceId == null) {
            throw new ApiException("Missing the required parameter 'spaceId' when calling sendMessage(Async)");
        }
        ...
        com.squareup.okhttp.Call call = sendMessageCall(spaceId, id, progressListener, progressRequestListener);
        return call;
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#charge-flow-level-service--send-message">Send Payment Link Documentation</a>
     */
    public ChargeFlowLevel sendMessage(Long spaceId, Long id) throws ApiException {
        ApiResponse<ChargeFlowLevel> resp = sendMessageWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#charge-flow-level-service--send-message">Send Payment Link Documentation</a>
     */
    public ApiResponse<ChargeFlowLevel> sendMessageWithHttpInfo(Long spaceId, Long id) throws ApiException {
        com.squareup.okhttp.Call call = sendMessageValidateBeforeCall(spaceId, id, null, null);
        Type localVarReturnType = new TypeToken<ChargeFlowLevel>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Send Payment Link (asynchronously)
     * Sends the payment link of the charge flow level with the given &#39;id&#39;.
     * @param spaceId  (required)
     * @param id The id of the charge flow level whose payment link should be sent. (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#charge-flow-level-service--send-message">Send Payment Link Documentation</a>
     */
    public com.squareup.okhttp.Call sendMessageAsync(Long spaceId, Long id, final ApiCallback<ChargeFlowLevel> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = sendMessageValidateBeforeCall(spaceId, id, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ChargeFlowLevel>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
