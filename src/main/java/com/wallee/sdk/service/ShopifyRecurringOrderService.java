...
import com.wallee.sdk.model.ShopifyRecurringOrder;
import com.wallee.sdk.model.ShopifyRecurringOrderUpdateRequest;
...
public class ShopifyRecurringOrderService {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-recurring-order-service--count">Count Documentation</a>
     */
    public com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/shopify-recurring-order/count";
     ...
     * Build call for read
     * @param spaceId  (required)
     * @param id The id of the Shopify recurring order which should be returned. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-recurring-order-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/shopify-recurring-order/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-recurring-order-service--read">Read Documentation</a>
     */
    public ShopifyRecurringOrder read(Long spaceId, Long id) throws ApiException {
        ApiResponse<ShopifyRecurringOrder> resp = readWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param id The id of the Shopify recurring order which should be returned. (required)
     * @return ApiResponse&lt;ShopifyRecurringOrder&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-recurring-order-service--read">Read Documentation</a>
     */
    public ApiResponse<ShopifyRecurringOrder> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
        com.squareup.okhttp.Call call = readValidateBeforeCall(spaceId, id, null, null);
        Type localVarReturnType = new TypeToken<ShopifyRecurringOrder>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-recurring-order-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<ShopifyRecurringOrder> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param query The query restricts the Shopify recurring orders which are returned by the search. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-recurring-order-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/shopify-recurring-order/search";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-recurring-order-service--search">Search Documentation</a>
     */
    public List<ShopifyRecurringOrder> search(Long spaceId, EntityQuery query) throws ApiException {
        ApiResponse<List<ShopifyRecurringOrder>> resp = searchWithHttpInfo(spaceId, query);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param query The query restricts the Shopify recurring orders which are returned by the search. (required)
     * @return ApiResponse&lt;List&lt;ShopifyRecurringOrder&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-recurring-order-service--search">Search Documentation</a>
     */
    public ApiResponse<List<ShopifyRecurringOrder>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
        com.squareup.okhttp.Call call = searchValidateBeforeCall(spaceId, query, null, null);
        Type localVarReturnType = new TypeToken<List<ShopifyRecurringOrder>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-recurring-order-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<ShopifyRecurringOrder>> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-recurring-order-service--update">Update Documentation</a>
     */
    public com.squareup.okhttp.Call updateCall(Long spaceId, ShopifyRecurringOrderUpdateRequest updateRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = updateRequest;

        // create path and map variables
        String localVarPath = "/shopify-recurring-order/update";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateValidateBeforeCall(Long spaceId, ShopifyRecurringOrderUpdateRequest updateRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateCall(spaceId, updateRequest, progressListener, progressRequestListener);
        return call;
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-recurring-order-service--update">Update Documentation</a>
     */
    public void update(Long spaceId, ShopifyRecurringOrderUpdateRequest updateRequest) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-recurring-order-service--update">Update Documentation</a>
     */
    public ApiResponse<Void> updateWithHttpInfo(Long spaceId, ShopifyRecurringOrderUpdateRequest updateRequest) throws ApiException {
        com.squareup.okhttp.Call call = updateValidateBeforeCall(spaceId, updateRequest, null, null);
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#shopify-recurring-order-service--update">Update Documentation</a>
     */
    public com.squareup.okhttp.Call updateAsync(Long spaceId, ShopifyRecurringOrderUpdateRequest updateRequest, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateValidateBeforeCall(spaceId, updateRequest, progressListener, progressRequestListener);
