  ...
  /**
    ...
    **/
    ...
    public HttpResponse activateProcessorForProductionForHttpResponse(Long spaceId, String externalId) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/payment-web-app/activate-processor-for-production");
        if (spaceId != null) {
            String key = "spaceId";
  ...
  /**
    ...
    **/
    ...
    public HttpResponse deleteConnectorForHttpResponse(Long spaceId, String externalId) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/payment-web-app/delete-connector");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    **/
    ...
    public HttpResponse deleteProcessorForHttpResponse(Long spaceId, String externalId) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/payment-web-app/delete-processor");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    **/
    ...
    public HttpResponse insertOrUpdateConnectorForHttpResponse(Long spaceId, PaymentAppConnectorCreationRequest request) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/payment-web-app/insert-or-update-connector");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    **/
    ...
    public HttpResponse insertOrUpdateProcessorForHttpResponse(Long spaceId, PaymentAppProcessorCreationRequest request) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/payment-web-app/insert-or-update-processor");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    **/
    ...
    public HttpResponse updateChargeAttemptForHttpResponse(Long spaceId, PaymentAppChargeAttemptUpdateRequest request) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/payment-web-app/update-charge-attempt");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    **/
    ...
    public HttpResponse updateCompletionForHttpResponse(Long spaceId, PaymentAppCompletionUpdateRequest request) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/payment-web-app/update-completion");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    **/
    ...
    public HttpResponse updateRefundForHttpResponse(Long spaceId, PaymentAppRefundUpdateRequest request) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/payment-web-app/update-refund");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    **/
    ...
    public HttpResponse updateVoidForHttpResponse(Long spaceId, PaymentAppVoidUpdateRequest request) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/payment-web-app/update-void");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
