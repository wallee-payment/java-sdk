...
public class InstallmentPlanSliceConfigurationService {
  ...
  /**
    ...
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#installment-plan-slice-configuration-service--count">Count Documentation</a>
  ...
  /**
    ...
    **/
    ...
    public HttpResponse countForHttpResponse(Long spaceId, EntityQueryFilter filter) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/installment-plan-slice-configuration/count");
        if (spaceId != null) {
            String key = "spaceId";
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#installment-plan-slice-configuration-service--read">Read Documentation</a>
    ...
    **/
    public InstallmentPlanSliceConfiguration read(Long spaceId, Long id) throws IOException {
        ...
        if(returnType.equals("String")){
          return (InstallmentPlanSliceConfiguration) (Object) response.parseAsString();
        }
  ...
  /**
    ...
    **/
    ...
    public HttpResponse readForHttpResponse(Long spaceId, Long id) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/installment-plan-slice-configuration/read");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#installment-plan-slice-configuration-service--search">Search Documentation</a>
    ...
    **/
    public List<InstallmentPlanSliceConfiguration> search(Long spaceId, EntityQuery query) throws IOException {
        ...
        if(returnType.equals("String")){
          return (List<InstallmentPlanSliceConfiguration>) (Object) response.parseAsString();
        }
  ...
  /**
    ...
    **/
    ...
    public HttpResponse searchForHttpResponse(Long spaceId, EntityQuery query) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/installment-plan-slice-configuration/search");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
