...
public class SubscriptionService {
	...
	private com.squareup.okhttp.Call searchSubscriptionInvoicesCall(Long spaceId, Long subscriptionId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody = query;
		...
		// create path and map variables
		String localVarPath = "/subscription/searchSubscriptionInvoices".replaceAll("\\{format\\}","json");
	...
	public ApiResponse<List<TransactionInvoice>> searchSubscriptionInvoicesWithHttpInfo(Long spaceId, Long subscriptionId, EntityQuery query) throws ApiException {
		com.squareup.okhttp.Call call = searchSubscriptionInvoicesCall(spaceId, subscriptionId, query, null, null);
