...
public class DebtCollectorConfigurationService {
	...
	private com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		String localVarPath = "/debt-collector-configuration/count".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/debt-collector-configuration/read".replaceAll("\\{format\\}","json");
	 ...
	 * @param spaceId  (required)
	 *
	 * @param id The id of the debt collector configuration which should be returned. (required)
	 * @return DebtCollectorConfiguration
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public DebtCollectorConfiguration read(Long spaceId, Long id) throws ApiException {
		ApiResponse<DebtCollectorConfiguration> resp = readWithHttpInfo(spaceId, id);
		return resp.getData();
	}
	 ...
	 *
	 * @param id The id of the debt collector configuration which should be returned. (required)
	 * @return ApiResponse&lt;DebtCollectorConfiguration&gt;
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public ApiResponse<DebtCollectorConfiguration> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
		com.squareup.okhttp.Call call = readCall(spaceId, id, null, null);
		Type localVarReturnType = new TypeToken<DebtCollectorConfiguration>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 * @throws ApiException If fail to process the API call, e.g. serializing the request body object
	 */
	public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<DebtCollectorConfiguration> callback) throws ApiException {
	...
	private com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/debt-collector-configuration/search".replaceAll("\\{format\\}","json");
	 ...
	 * @param spaceId  (required)
	 *
	 * @param query The query restricts the debt collector configuration which are returned by the search. (required)
	 * @return List&lt;DebtCollectorConfiguration&gt;
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public List<DebtCollectorConfiguration> search(Long spaceId, EntityQuery query) throws ApiException {
		ApiResponse<List<DebtCollectorConfiguration>> resp = searchWithHttpInfo(spaceId, query);
		return resp.getData();
	}
	 ...
	 *
	 * @param query The query restricts the debt collector configuration which are returned by the search. (required)
	 * @return ApiResponse&lt;List&lt;DebtCollectorConfiguration&gt;&gt;
	 * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
	 */
	public ApiResponse<List<DebtCollectorConfiguration>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
		com.squareup.okhttp.Call call = searchCall(spaceId, query, null, null);
		Type localVarReturnType = new TypeToken<List<DebtCollectorConfiguration>>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 * @throws ApiException If fail to process the API call, e.g. serializing the request body object
	 */
	public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<DebtCollectorConfiguration>> callback) throws ApiException {
