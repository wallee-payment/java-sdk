...
public class BankAccountService {
    ...
    public BankAccountService(ApiClient apiClient) {
  ...
  /**
    ...
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#bank-account-service--count">Count Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#bank-account-service--read">Read Documentation</a>

    **/
    public BankAccount read(Long spaceId, Long id) throws IOException {
        HttpResponse response = readForHttpResponse(spaceId, id);
        String returnType = "BankAccount";
        if(returnType.equals("String")){
          return (BankAccount) (Object) response.parseAsString();
        }
        TypeReference typeRef = new TypeReference<BankAccount>() {};
        if (isNoBodyResponse(response)) {
            throw new WalleeSdkException(ErrorCode.ENTITY_NOT_FOUND, "Entity was not found for: " + typeRef.getType().getTypeName());
        }
        return (BankAccount)apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }
  ...
  /**
    ...
    **/
    public BankAccount read(Long spaceId, Long id, Map<String, Object> params) throws IOException {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#bank-account-service--search">Search Documentation</a>

    **/
    public List<BankAccount> search(Long spaceId, EntityQuery query) throws IOException {
        HttpResponse response = searchForHttpResponse(spaceId, query);
        String returnType = "List&lt;BankAccount&gt;";
        if(returnType.equals("String")){
          return (List<BankAccount>) (Object) response.parseAsString();
        }
        TypeReference typeRef = new TypeReference<List<BankAccount>>() {};
        if (isNoBodyResponse(response)) {
            throw new WalleeSdkException(ErrorCode.ENTITY_NOT_FOUND, "Entity was not found for: " + typeRef.getType().getTypeName());
        }
        return (List<BankAccount>)apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }
  ...
  /**
    ...
    **/
    public List<BankAccount> search(Long spaceId, EntityQuery query, Map<String, Object> params) throws IOException {
