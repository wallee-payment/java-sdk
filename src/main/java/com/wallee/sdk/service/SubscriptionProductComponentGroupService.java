...
public class SubscriptionProductComponentGroupService {
  ...
  /**
    ...
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#subscription-product-component-group-service--count">Count Documentation</a>
    ...
    public HttpResponse countForHttpResponse(Long spaceId, EntityQueryFilter filter) throws IOException {
        ...
        if (spaceId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'spaceId' when calling count");
                ...
                URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/subscription-product-component-group/count");
        if (spaceId != null) {
            String key = "spaceId";
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#subscription-product-component-group-service--create">Create Documentation</a>
    ...
    **/
    public SubscriptionProductComponentGroup create(Long spaceId, SubscriptionProductComponentGroupUpdate entity) throws IOException {
        ...
        if(returnType.equals("String")){
          return (SubscriptionProductComponentGroup) (Object) response.parseAsString();
        }
  ...
  /**
    ...
    **/
    ...
    public HttpResponse createForHttpResponse(Long spaceId, SubscriptionProductComponentGroupUpdate entity) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/subscription-product-component-group/create");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#subscription-product-component-group-service--delete">Delete Documentation</a>
  ...
  /**
    ...
    **/
    ...
    public HttpResponse deleteForHttpResponse(Long spaceId, Long id) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/subscription-product-component-group/delete");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#subscription-product-component-group-service--read">Read Documentation</a>
  ...
  /**
    ...
    **/
    ...
    public HttpResponse readForHttpResponse(Long spaceId, Long id) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/subscription-product-component-group/read");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#subscription-product-component-group-service--search">Search Documentation</a>
    ...
    **/
    public List<SubscriptionProductComponentGroup> search(Long spaceId, EntityQuery query) throws IOException {
        ...
        if(returnType.equals("String")){
          return (List<SubscriptionProductComponentGroup>) (Object) response.parseAsString();
        }
  ...
  /**
    ...
    **/
    ...
    public HttpResponse searchForHttpResponse(Long spaceId, EntityQuery query) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/subscription-product-component-group/search");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#subscription-product-component-group-service--update">Update Documentation</a>
  ...
  /**
    ...
    **/
    ...
    public HttpResponse updateForHttpResponse(Long spaceId, SubscriptionProductComponentGroupUpdate entity) throws IOException {
        ...
        URIBuilder uriBuilder = URIBuilderUtil.create(apiClient.getBasePath() + "/subscription-product-component-group/update");
        if (spaceId != null) {
            String key = "spaceId";
            Object value = spaceId;
            uriBuilder = URIBuilderUtil.applyQueryParam(uriBuilder, key, value);
