...
public class PermissionService {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#permission-service--all">All Documentation</a>
     */
    public com.squareup.okhttp.Call allCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/permission/all";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#permission-service--all">All Documentation</a>
     */
    public List<Permission> all() throws ApiException {
        ApiResponse<List<Permission>> resp = allWithHttpInfo();
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#permission-service--all">All Documentation</a>
     */
    public ApiResponse<List<Permission>> allWithHttpInfo() throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#permission-service--all">All Documentation</a>
     */
    public com.squareup.okhttp.Call allAsync(final ApiCallback<List<Permission>> callback) throws ApiException {
    ...
    /**
     * Build call for read
     * @param id The id of the permission which should be returned. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#permission-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readCall(Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/permission/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#permission-service--read">Read Documentation</a>
     */
    public Permission read(Long id) throws ApiException {
        ApiResponse<Permission> resp = readWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#permission-service--read">Read Documentation</a>
     */
    public ApiResponse<Permission> readWithHttpInfo(Long id) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#permission-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long id, final ApiCallback<Permission> callback) throws ApiException {
