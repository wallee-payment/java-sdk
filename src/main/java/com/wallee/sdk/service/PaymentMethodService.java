...
public class PaymentMethodService {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-service--all">All Documentation</a>
     */
    public com.squareup.okhttp.Call allCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/payment-method/all";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-service--all">All Documentation</a>
     */
    public List<PaymentMethod> all() throws ApiException {
        ApiResponse<List<PaymentMethod>> resp = allWithHttpInfo();
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-service--all">All Documentation</a>
     */
    public ApiResponse<List<PaymentMethod>> allWithHttpInfo() throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-service--all">All Documentation</a>
     */
    public com.squareup.okhttp.Call allAsync(final ApiCallback<List<PaymentMethod>> callback) throws ApiException {
    ...
    /**
     * Build call for read
     * @param id The id of the payment method which should be returned. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readCall(Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/payment-method/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-service--read">Read Documentation</a>
     */
    public PaymentMethod read(Long id) throws ApiException {
        ApiResponse<PaymentMethod> resp = readWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-service--read">Read Documentation</a>
     */
    public ApiResponse<PaymentMethod> readWithHttpInfo(Long id) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long id, final ApiCallback<PaymentMethod> callback) throws ApiException {
