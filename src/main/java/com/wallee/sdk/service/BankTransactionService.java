...
public class BankTransactionService {
    ...
    public BankTransactionService(ApiClient apiClient) {
  ...
  /**
    ...
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#bank-transaction-service--count">Count Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#bank-transaction-service--read">Read Documentation</a>

    **/
    public BankTransaction read(Long spaceId, Long id) throws IOException {
        HttpResponse response = readForHttpResponse(spaceId, id);
        String returnType = "BankTransaction";
        if(returnType.equals("String")){
          return (BankTransaction) (Object) response.parseAsString();
        }
        TypeReference typeRef = new TypeReference<BankTransaction>() {};
        if (isNoBodyResponse(response)) {
            throw new WalleeSdkException(ErrorCode.ENTITY_NOT_FOUND, "Entity was not found for: " + typeRef.getType().getTypeName());
        }
        return (BankTransaction)apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }
  ...
  /**
    ...
    **/
    public BankTransaction read(Long spaceId, Long id, Map<String, Object> params) throws IOException {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://app-wallee.com/doc/api/web-service/v1#bank-transaction-service--search">Search Documentation</a>

    **/
    public List<BankTransaction> search(Long spaceId, EntityQuery query) throws IOException {
        HttpResponse response = searchForHttpResponse(spaceId, query);
        String returnType = "List&lt;BankTransaction&gt;";
        if(returnType.equals("String")){
          return (List<BankTransaction>) (Object) response.parseAsString();
        }
        TypeReference typeRef = new TypeReference<List<BankTransaction>>() {};
        if (isNoBodyResponse(response)) {
            throw new WalleeSdkException(ErrorCode.ENTITY_NOT_FOUND, "Entity was not found for: " + typeRef.getType().getTypeName());
        }
        return (List<BankTransaction>)apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }
  ...
  /**
    ...
    **/
    public List<BankTransaction> search(Long spaceId, EntityQuery query, Map<String, Object> params) throws IOException {
