...
public class PaymentMethodBrandService {
    ...
    public com.squareup.okhttp.Call allCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/payment-method-brand/all";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-brand-service--all">All Documentation</a>
     */
    public List<PaymentMethodBrand> all() throws ApiException {
        ApiResponse<List<PaymentMethodBrand>> resp = allWithHttpInfo();
        return resp.getData();
    }
     ...
     * All
     * This operation returns all entities which are available.
     * @return ApiResponse&lt;List&lt;PaymentMethodBrand&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-brand-service--all">All Documentation</a>
     */
    public ApiResponse<List<PaymentMethodBrand>> allWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = allValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<List<PaymentMethodBrand>>(){}.getType();
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-brand-service--all">All Documentation</a>
     */
    public com.squareup.okhttp.Call allAsync(final ApiCallback<List<PaymentMethodBrand>> callback) throws ApiException {
    ...
    /**
     * Build call for read
     * @param id The id of the payment method brand which should be returned. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call readCall(Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/payment-method-brand/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-brand-service--read">Read Documentation</a>
     */
    public PaymentMethodBrand read(Long id) throws ApiException {
        ApiResponse<PaymentMethodBrand> resp = readWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * Reads the entity with the given &#39;id&#39; and returns it.
     * @param id The id of the payment method brand which should be returned. (required)
     * @return ApiResponse&lt;PaymentMethodBrand&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-brand-service--read">Read Documentation</a>
     */
    public ApiResponse<PaymentMethodBrand> readWithHttpInfo(Long id) throws ApiException {
        com.squareup.okhttp.Call call = readValidateBeforeCall(id, null, null);
        Type localVarReturnType = new TypeToken<PaymentMethodBrand>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#payment-method-brand-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long id, final ApiCallback<PaymentMethodBrand> callback) throws ApiException {
