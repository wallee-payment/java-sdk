...
public class SubscriptionAffiliateService {
	...
	private com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		String localVarPath = "/subscription-affiliate/count".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call createCall(Long spaceId, SubscriptionAffiliateCreate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/subscription-affiliate/create".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call deleteCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/subscription-affiliate/delete".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/subscription-affiliate/read".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/subscription-affiliate/search".replaceAll("\\{format\\}","json");
	...
	private com.squareup.okhttp.Call updateCall(Long spaceId, SubscriptionAffiliateUpdate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody = entity;
		...
		// create path and map variables
		String localVarPath = "/subscription-affiliate/update".replaceAll("\\{format\\}","json");
