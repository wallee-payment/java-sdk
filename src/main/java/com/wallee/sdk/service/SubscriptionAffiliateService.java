...
public class SubscriptionAffiliateService {
    private ApiClient apiClient;

    public SubscriptionAffiliateService(ApiClient apiClient) {
    ...
    public com.squareup.okhttp.Call countCall(Long spaceId, EntityQueryFilter filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/subscription-affiliate/count";
     ...
     * @param spaceId  (required)
     * @param entity The subscription affiliate object with the properties which should be created. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public com.squareup.okhttp.Call createCall(Long spaceId, SubscriptionAffiliateCreate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = entity;

        // create path and map variables
        String localVarPath = "/subscription-affiliate/create";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createValidateBeforeCall(Long spaceId, SubscriptionAffiliateCreate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-affiliate-service--create">Create Documentation</a>
     */
    public SubscriptionAffiliate create(Long spaceId, SubscriptionAffiliateCreate entity) throws ApiException {
        ApiResponse<SubscriptionAffiliate> resp = createWithHttpInfo(spaceId, entity);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param entity The subscription affiliate object with the properties which should be created. (required)
     * @return ApiResponse&lt;SubscriptionAffiliate&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-affiliate-service--create">Create Documentation</a>
     */
    public ApiResponse<SubscriptionAffiliate> createWithHttpInfo(Long spaceId, SubscriptionAffiliateCreate entity) throws ApiException {
        com.squareup.okhttp.Call call = createValidateBeforeCall(spaceId, entity, null, null);
        Type localVarReturnType = new TypeToken<SubscriptionAffiliate>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-affiliate-service--create">Create Documentation</a>
     */
    public com.squareup.okhttp.Call createAsync(Long spaceId, SubscriptionAffiliateCreate entity, final ApiCallback<SubscriptionAffiliate> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call deleteCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscription-affiliate/delete";
     ...
     * Build call for read
     * @param spaceId  (required)
     * @param id The id of the subscription affiliate case which should be returned. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call readCall(Long spaceId, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscription-affiliate/read";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-affiliate-service--read">Read Documentation</a>
     */
    public SubscriptionAffiliate read(Long spaceId, Long id) throws ApiException {
        ApiResponse<SubscriptionAffiliate> resp = readWithHttpInfo(spaceId, id);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-affiliate-service--read">Read Documentation</a>
     */
    public ApiResponse<SubscriptionAffiliate> readWithHttpInfo(Long spaceId, Long id) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-affiliate-service--read">Read Documentation</a>
     */
    public com.squareup.okhttp.Call readAsync(Long spaceId, Long id, final ApiCallback<SubscriptionAffiliate> callback) throws ApiException {
     ...
     * @param spaceId  (required)
     * @param query The query restricts the affiliates which are returned by the search. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call searchCall(Long spaceId, EntityQuery query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscription-affiliate/search";
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-affiliate-service--search">Search Documentation</a>
     */
    public List<SubscriptionAffiliate> search(Long spaceId, EntityQuery query) throws ApiException {
        ApiResponse<List<SubscriptionAffiliate>> resp = searchWithHttpInfo(spaceId, query);
        return resp.getData();
    }
     ...
     * @param spaceId  (required)
     * @param query The query restricts the affiliates which are returned by the search. (required)
     * @return ApiResponse&lt;List&lt;SubscriptionAffiliate&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * For more information visit this link.
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-affiliate-service--search">Search Documentation</a>
     */
    public ApiResponse<List<SubscriptionAffiliate>> searchWithHttpInfo(Long spaceId, EntityQuery query) throws ApiException {
        com.squareup.okhttp.Call call = searchValidateBeforeCall(spaceId, query, null, null);
        Type localVarReturnType = new TypeToken<List<SubscriptionAffiliate>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-affiliate-service--search">Search Documentation</a>
     */
    public com.squareup.okhttp.Call searchAsync(Long spaceId, EntityQuery query, final ApiCallback<List<SubscriptionAffiliate>> callback) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call updateCall(Long spaceId, SubscriptionAffiliateUpdate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = entity;

        // create path and map variables
        String localVarPath = "/subscription-affiliate/update";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateValidateBeforeCall(Long spaceId, SubscriptionAffiliateUpdate entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-affiliate-service--update">Update Documentation</a>
     */
    public SubscriptionAffiliate update(Long spaceId, SubscriptionAffiliateUpdate entity) throws ApiException {
        ApiResponse<SubscriptionAffiliate> resp = updateWithHttpInfo(spaceId, entity);
        return resp.getData();
    }
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-affiliate-service--update">Update Documentation</a>
     */
    public ApiResponse<SubscriptionAffiliate> updateWithHttpInfo(Long spaceId, SubscriptionAffiliateUpdate entity) throws ApiException {
     ...
     * @see <a href="https://app-wallee.com/doc/api/web-service#subscription-affiliate-service--update">Update Documentation</a>
     */
    public com.squareup.okhttp.Call updateAsync(Long spaceId, SubscriptionAffiliateUpdate entity, final ApiCallback<SubscriptionAffiliate> callback) throws ApiException {
