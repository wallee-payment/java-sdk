...
The Wallee Java SDK is used to interact with Wallee`s REST API.
...
```groovy
  ...
  dependencies {
     implementation "com.wallee:wallee-java-sdk:9.2.0"
  }
```
...
import com.wallee.sdk.service.TransactionsService;
